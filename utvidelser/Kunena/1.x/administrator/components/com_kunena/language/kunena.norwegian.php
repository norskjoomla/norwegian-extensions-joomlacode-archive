...
define('_KUNENA_JS_ACTIVITYSTREAM_CREATE_MSG1', 'opprett nytt emne');
define('_KUNENA_JS_ACTIVITYSTREAM_CREATE_MSG2', 'i forumene.');
define('_KUNENA_JS_ACTIVITYSTREAM_REPLY_MSG1', 'svarte på emnet');
define('_KUNENA_JS_ACTIVITYSTREAM_REPLY_MSG2', 'i forumene.');

define('_KUNENA_AUP_ALPHAUSERPOINTS', 'AlphaUserPoints');
define('_KUNENA_AUP_ENABLED_POINTS_IN_PROFILE', 'Aktiver poeng i profil');
define('_KUNENA_AUP_ENABLED_POINTS_IN_PROFILE_DESC', 'Om du har AlphaUserPoints installert kan du konfigurere Kunena til å vise en brukers gjeldende poeng i vedkommendes profil.');
define('_KUNENA_AUP_ENABLED_RULES', 'Aktiver regler for poeng');
define('_KUNENA_AUP_ENABLED_RULES_DESC', 'Du kan bruke forhåndsdefinerte regler i AlphaUserPoints til å gi poeng for nye emner og svar. Du må ha AlphaUserPoints 1.5.3 eller nyere installert. Om du har en eldre versjon må du manuelt installere reglene (se dokumentasjon for AlphaUserPoints).');
define('_KUNENA_AUP_MINIMUM_POINTS_ON_REPLY', 'Minimum tegn ved svar');
define('_KUNENA_AUP_MINIMUM_POINTS_ON_REPLY_DESC', 'Minimum tegn i svartekst som kvalifiserer til opptjening av poeng i svar på emner.');
define('_KUNENA_AUP_MESSAGE_TOO_SHORT', 'Din respons var for kort til å gi deg noen nye poeng.');
define('_KUNENA_AUP_POINTS', 'Poeng:');
...
DEFINE('_KUNENA_VERSION_ALPHA_WARNING', 'Denne utgaven skal ikke benyttes på portaler i drift.');
DEFINE('_KUNENA_VERSION_BETA_WARNING', 'Denne utgaven anbefales ikke benyttet på portaler i drift.');	
DEFINE('_KUNENA_VERSION_RC_WARNING', 'Denne utgaven vil kunne inneholde feil, men disse vil bli rettet i den endelige utgaven.');	
DEFINE('_KUNENA_ERROR_UPGRADE', 'Oppgradering av Kunena til versjon %s feilet!');
...
DEFINE('_KUNENA_INTEGRATION_CB_WARN_UPDATE', 'Profilintegrasjonen med Community Builders brukerprofil virker kun dersom du bruker Community Builder versjon %s eller høyere.');
DEFINE('_KUNENA_INTEGRATION_CB_WARN_XHTML', 'Profilintegrasjonen med Community Builders brukerprofil virker kun dersom Community Builder er i W3C XHTML 1.0 Trans. compliance mode.');
...
DEFINE('_KUNENA_INTEGRATION_CB_WARN_HIDE', 'Lagring av Kunena-konfigurasjonen vil avbryte integrasjonen og skjule denne advarselen.');
...
DEFINE('_KUNENA_EDITOR_HELPLINE_OL', 'Nummerering: [ol] [li]Tekst[/li] [/ol] - Tips: En liste må inneholde listeelementer');
DEFINE('_KUNENA_EDITOR_HELPLINE_LI', 'Listeelement: [li] Listeelement [/li]');
DEFINE('_KUNENA_EDITOR_HELPLINE_ALIGN_LEFT', 'Venstrejustert: [left]Tekst[/left]');
DEFINE('_KUNENA_EDITOR_HELPLINE_ALIGN_CENTER', 'Midtstilt: [center]Tekst[/center]');
DEFINE('_KUNENA_EDITOR_HELPLINE_ALIGN_RIGHT', 'Høyrejustert: [right]Tekst[/right]');
DEFINE('_KUNENA_EDITOR_HELPLINE_IMAGELINK', 'Bildelenke: [img size=400]http://www.google.com/images/web_logo_left.gif[/img]');
DEFINE('_KUNENA_EDITOR_HELPLINE_IMAGELINKSIZE', 'Bildelenke: Str.');
DEFINE('_KUNENA_EDITOR_HELPLINE_IMAGELINKURL', 'Bildelenke: Nettadresse for bildelenken.');
DEFINE('_KUNENA_EDITOR_HELPLINE_IMAGELINKAPPLY', 'Bildelenke: Bruk bildelenke');
DEFINE('_KUNENA_EDITOR_HELPLINE_LINK', 'Lenke: [url=http://www.zzz.com/]Dette er en lenke[/url]');
DEFINE('_KUNENA_EDITOR_HELPLINE_LINKURL', 'Lenke: Nettadresse for lenken');
...
DEFINE('_KUNENA_EDITOR_HELPLINE_EBAY', 'eBay: [ebay]Elementident[/ebay]');
DEFINE('_KUNENA_EDITOR_HELPLINE_VIDEO', 'Video: Velg leverandør eller nettadressemodus');
DEFINE('_KUNENA_EDITOR_HELPLINE_VIDEOSIZE', 'Video: Videoens størrelse');
DEFINE('_KUNENA_EDITOR_HELPLINE_VIDEOWIDTH', 'Video: Videoens bredde');
DEFINE('_KUNENA_EDITOR_HELPLINE_VIDEOHEIGHT', 'Video: Videoens høyde');
DEFINE('_KUNENA_EDITOR_HELPLINE_VIDEOPROVIDER', 'Video: Velg leverandør av video');
DEFINE('_KUNENA_EDITOR_HELPLINE_VIDEOID', 'Video: ID for videoen - du kan se denne i videoens nettadresse');
DEFINE('_KUNENA_EDITOR_HELPLINE_VIDEOAPPLY1', 'Video: [video size=100 width=480 height=360 provider=clipfish]3423432[/video]');
DEFINE('_KUNENA_EDITOR_HELPLINE_VIDEOURL', 'Video: Nettadresse for videoen');
...
DEFINE('_KUNENA_EDITOR_HELPLINE_IMGPH', 'Sett inn [img] plassholder i posten for bildevedlegg');
DEFINE('_KUNENA_EDITOR_HELPLINE_FILEPH', 'Sett inn [file] plassholder i posten for filvedlegg');
DEFINE('_KUNENA_EDITOR_HELPLINE_SUBMIT', 'Klikk her for å sende meldingen din');
DEFINE('_KUNENA_EDITOR_HELPLINE_PREVIEW', 'Klikk her for å forhåndsvise meldingen din');
DEFINE('_KUNENA_EDITOR_HELPLINE_CANCEL', 'Klikk her for å avbryte meldingen din');
DEFINE('_KUNENA_EDITOR_HELPLINE_HINT', 'bbCode Hjelp - Tips: bbCode kan benyttes for valgt tekst!');
DEFINE('_KUNENA_EDITOR_LINK_URL', ' Nettadr.: ');
DEFINE('_KUNENA_EDITOR_LINK_TEXT', ' Tekst: ');
DEFINE('_KUNENA_EDITOR_LINK_INSERT', 'Sett inn');
DEFINE('_KUNENA_EDITOR_IMAGE_SIZE', ' Str.: ');
DEFINE('_KUNENA_EDITOR_IMAGE_URL', ' Nettadr.: ');
DEFINE('_KUNENA_EDITOR_IMAGE_INSERT', 'Sett inn');
DEFINE('_KUNENA_EDITOR_VIDEO_SIZE', 'Str.: ');
DEFINE('_KUNENA_EDITOR_VIDEO_WIDTH', 'Bredde: ');
DEFINE('_KUNENA_EDITOR_VIDEO_HEIGHT', 'Høyde:');
DEFINE('_KUNENA_EDITOR_VIDEO_URL', 'Nettadr.: ');
DEFINE('_KUNENA_EDITOR_VIDEO_ID', 'ID: ');
DEFINE('_KUNENA_EDITOR_VIDEO_PROVIDER', 'Leverandør: ');
DEFINE('_KUNENA_BBCODE_HIDDENTEXT', '<span class="fb_quote">Noe innhold er skjult for gjester. Logg inn eller registrer deg for å se det.</span>');

DEFINE('_KUNENA_PROFILE_BIRTHDAY', 'Fødselsdag');
DEFINE('_KUNENA_DT_MONTHDAY_FMT','%m/%d');
DEFINE('_KUNENA_CFC_FILENAME','CSS-fil som ønskes endret');
...
DEFINE('_KUNENA_JS_WARN_MAIL_MISSING','E-postadresse mangler');
...
DEFINE('_KUNENA_COPYRIGHT', 'Kopirett');
DEFINE('_KUNENA_LICENSE', 'Lisens');
DEFINE('_KUNENA_PROFILE_NO_USER', 'Bruker eksisterer ikke.');
DEFINE('_KUNENA_PROFILE_NOT_FOUND', 'Brukeren har ennå ikke besøkt forumet og har derfor ingen profil.');

// Search
DEFINE('_KUNENA_SEARCH_RESULTS', 'Søkeresultat');
DEFINE('_KUNENA_SEARCH_ADVSEARCH', 'Avansert søk');
DEFINE('_KUNENA_SEARCH_SEARCHBY_KEYWORD', 'Søk etter nøkkelord');
DEFINE('_KUNENA_SEARCH_KEYWORDS', 'Nøkkelord');
DEFINE('_KUNENA_SEARCH_SEARCH_POSTS', 'Søk i hele innlegg');
DEFINE('_KUNENA_SEARCH_SEARCH_TITLES', 'Søk bare i tittel');
DEFINE('_KUNENA_SEARCH_SEARCHBY_USER', 'Søk etter brukernavn');
DEFINE('_KUNENA_SEARCH_UNAME', 'Brukernavn');
DEFINE('_KUNENA_SEARCH_EXACT', 'Nøyaktig navn');
DEFINE('_KUNENA_SEARCH_USER_POSTED', 'Innlegg postet av');
DEFINE('_KUNENA_SEARCH_USER_STARTED', 'Tråder startet av');
DEFINE('_KUNENA_SEARCH_USER_ACTIVE', 'Aktivitet i tråder');
DEFINE('_KUNENA_SEARCH_OPTIONS', 'Søkevalg');
DEFINE('_KUNENA_SEARCH_FIND_WITH', 'Finn tråder med');
DEFINE('_KUNENA_SEARCH_LEAST', 'Minimum');
DEFINE('_KUNENA_SEARCH_MOST', 'Maksimum');
DEFINE('_KUNENA_SEARCH_ANSWERS', 'Svar');
DEFINE('_KUNENA_SEARCH_FIND_POSTS', 'Finn innlegg fra');
DEFINE('_KUNENA_SEARCH_DATE_ANY', 'Uansett dato');
DEFINE('_KUNENA_SEARCH_DATE_LASTVISIT', 'Siste besøk');
DEFINE('_KUNENA_SEARCH_DATE_YESTERDAY', 'I går');
DEFINE('_KUNENA_SEARCH_DATE_WEEK', '1 uke siden');
DEFINE('_KUNENA_SEARCH_DATE_2WEEKS', '2 uker siden');
DEFINE('_KUNENA_SEARCH_DATE_MONTH', '1 måned siden');
DEFINE('_KUNENA_SEARCH_DATE_3MONTHS', '3 måneder siden');
DEFINE('_KUNENA_SEARCH_DATE_6MONTHS', '6 måneder siden');
DEFINE('_KUNENA_SEARCH_DATE_YEAR', '1 år siden');
DEFINE('_KUNENA_SEARCH_DATE_NEWER', 'Eller nyere');
DEFINE('_KUNENA_SEARCH_DATE_OLDER', 'Eller eldre');
DEFINE('_KUNENA_SEARCH_SORTBY', 'Sorter treff etter');
DEFINE('_KUNENA_SEARCH_SORTBY_TITLE', 'Tittel');
DEFINE('_KUNENA_SEARCH_SORTBY_POSTS', 'Antall innlegg');
DEFINE('_KUNENA_SEARCH_SORTBY_VIEWS', 'Antall visninger');
DEFINE('_KUNENA_SEARCH_SORTBY_START', 'Trådens startdato');
DEFINE('_KUNENA_SEARCH_SORTBY_POST', 'Dato for innlegg');
DEFINE('_KUNENA_SEARCH_SORTBY_USER', 'Brukernavn');
DEFINE('_KUNENA_SEARCH_SORTBY_FORUM', 'Forum');
DEFINE('_KUNENA_SEARCH_SORTBY_INC', 'Stigende rekkefølge');
DEFINE('_KUNENA_SEARCH_SORTBY_DEC', 'Synkende rekkefølge');
DEFINE('_KUNENA_SEARCH_START', 'Hopp til treff nummer');
DEFINE('_KUNENA_SEARCH_LIMIT5', 'Vis 5 søketreff');
DEFINE('_KUNENA_SEARCH_LIMIT10', 'Vis 10 søketreff');
DEFINE('_KUNENA_SEARCH_LIMIT15', 'Vis 15 søketreff');
DEFINE('_KUNENA_SEARCH_LIMIT20', 'Vis 20 søketreff');
DEFINE('_KUNENA_SEARCH_SEARCHIN', 'Søk i kategorier');
DEFINE('_KUNENA_SEARCH_SEARCHIN_ALLCATS', 'Alle kategorier');
DEFINE('_KUNENA_SEARCH_SEARCHIN_CHILDREN', 'Søk også i underforumene');
DEFINE('_KUNENA_SEARCH_SEND', 'Start');
DEFINE('_KUNENA_SEARCH_CANCEL', 'Avbryt');
DEFINE('_KUNENA_SEARCH_ERR_NOPOSTS', 'Ingen innlegg inneholdt alle dine søkevalg.');
DEFINE('_KUNENA_SEARCH_ERR_SHORTKEYWORD', 'Minst et nøkkelord må være på minimum tre tegn!');
...
DEFINE('_KUNENA_CONFIGSAVED', 'Konfigurasjonsfil er lagret');
DEFINE('_KUNENA_CONFIGNOTSAVED', 'ALVORLIG FEIL: Du kan ikke skrive til konfigurasjonsfilen');
DEFINE('_KUNENA_TFINW', 'Filen er skrivebeskyttet.');
DEFINE('_KUNENA_FBCFS', 'Kunenas CSS-fil ble lagret.');
