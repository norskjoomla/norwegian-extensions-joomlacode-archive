...
// Editor
DEFINE('_KUNENA_EDITOR_HELPLINE_BOLD', 'Uthevet tekst: [b]text[/b]');
...
DEFINE('_KUNENA_EDITOR_HELPLINE_ALIGN_CENTER', 'Sentrert: [center]Tekst[/center]');
...
DEFINE('_KUNENA_EDITOR_HELPLINE_COLOR', 'Farge: [color=#FF6600]text[/color]');
DEFINE('_KUNENA_EDITOR_HELPLINE_FONTSIZE', 'Fontstr.: [size=1]text size[/size] - Tip: sizes range from 1 to 5');
...
DEFINE('_KUNENA_EDITOR_HELPLINE_VIDEOAPPLY1', 'Video: [video str=100 bredde=480 høyde=360 provider=clipfish]3423432[/video]');
DEFINE('_KUNENA_EDITOR_HELPLINE_VIDEOURL', 'Video: URL for videoen');
DEFINE('_KUNENA_EDITOR_HELPLINE_VIDEOAPPLY2', 'Video: [video str.=100 bredde=480 høyde=360]http://myvideodomain.com/myvideo[/video]');
