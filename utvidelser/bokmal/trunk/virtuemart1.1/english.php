...
/**
*
* @version $Id: english.php 686 2007-02-20 07:32:54Z soeren_nb $
* @package VirtueMart
...
class vmLanguage extends vmAbstractLanguage {
	...
	var $_PHPSHOP_FUNC_ISNO_REG = ' is not a valid VirtueMart function.';
	...
	var $_PHPSHOP_PRODUCT_FORM_THUMB_IMAGE = 'Thumbnail Image';
  ...
  select the status which enables the download (then the customer is instantly notified about the download via e-mail).';
	...
	var $_PHPSHOP_FILES_FORM_FILE = 'additional File';
	var $_PHPSHOP_FILES_FORM_IMAGE = 'additional Image';
