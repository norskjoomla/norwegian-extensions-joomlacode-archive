...
* Oversettelse er hentet fra gammel språkfil for versjon 1.0 av Sören Eberhardt-Biermann @ VirtueMart-teamet.
* Oversettelse og språkvask for versjon 1.1 av Odd-Eirik Eriksen (abc@abc-konsult.no).
...
$langvars = array (
	...
	'PHPSHOP_DOWNLOADS_INFO' => 'Vennligst skriv inn nedlastings-ID\'en du fikk per e-post. Deretter trykker du \'Start nedlasting\'.',
	'PHPSHOP_WAITING_LIST_MESSAGE' => 'Venligst skriv inn din E-postadresse for å få beskjed når dette produktet er på lager igjen.
',
	'PHPSHOP_WAITING_LIST_THANKS' => 'Takk for at du venter! <br />Vi vil gi deg beskjed så snart varen er på lager igjen.',
...
',
	...
	'PHPSHOP_PARAMETER_SEARCH_BAD_PRODUCT_TYPE' => 'Beklager, det er ingen publiserte produkttyper med dette navnet.',
	...
	'PHPSHOP_PRODUCT_PACKAGING1' => 'Antall {enhet}er i pakken:',
	'PHPSHOP_PRODUCT_PACKAGING2' => 'Antall {enhet}er i boks:',
	'PHPSHOP_CART_PRICE_PER_UNIT' => 'Pris',
	'VM_PRODUCT_ENQUIRY_LBL' => 'Still et spørsmål om dette produktet',
	'VM_RECOMMEND_FORM_LBL' => 'Anbefal dette produktet til en venn',
	'PHPSHOP_EMPTY_YOUR_CART' => 'Tøm handlekurv',
	'VM_RETURN_TO_PRODUCT' => 'Returner til produkt',
	'EMPTY_CATEGORY' => 'Denne kategorien er for øyeblikket tom.',
	'ENQUIRY' => 'Forespørsel',
	'NAME_PROMPT' => 'Ditt navn',
	'EMAIL_PROMPT' => 'Din e-postadresse',
	'MESSAGE_PROMPT' => 'Skriv din melding her',
	'SEND_BUTTON' => 'Send',
	'THANK_MESSAGE' => 'Takk for din forespørsel. Vi vil ta kontakt med deg så snart vi kan.',
	'PROMPT_CLOSE' => 'Lukk',
	'VM_RECOVER_CART_REPLACE' => 'Erstatt handlekurv med lagret handlekurv',
	'VM_RECOVER_CART_MERGE' => 'Tilføy lagret handlekurv til nåværende handlekurv',
	'VM_RECOVER_CART_DELETE' => 'Slett lagret handlekurv',
	'VM_EMPTY_YOUR_CART_TIP' => 'Tøm handlekurven'
