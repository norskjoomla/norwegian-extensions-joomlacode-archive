...
DEFINE('_COM_A_FBDEFAULT_PAGE_RECENT', 'Nyeste innlegg');
...
DEFINE('_KUNENA_UNIST_SUCCESS', "Kunenakomponenten er avinstallert!");
DEFINE('_KUNENA_PDF_VERSION', 'Kunena forumkomponent versjon: %version%');
