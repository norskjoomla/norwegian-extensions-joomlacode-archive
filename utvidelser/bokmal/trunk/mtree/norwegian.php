...
class mtLanguage {
	...
	/* My Listing */
	var $MY_LISTING = "Mine oppføringer";
	var $YOU_DO_NOT_HAVE_ANY_LISTING = "Du har ingen oppføringer";
	...
	var $LISTING_BY = "Oppføringer etter %s";
	...
	// New Review
	var $NEW_REVIEW_EMAIL_SUBJECT_WAITING_APPROVAL = "Ny omtale (venter godkjenning) - %s";
	...
	var $EXPLORER_TREE_LEVEL = "Utforskerens listenivå";
	var $FULLMENU_TREE_LEVEL = "Fullmenyens listenivå";
	...
	var $TEM_AZ = "A-Å";
	var $TEM_RATING_FORM = "Omtaleskjema";
	...
	var $ENTER_ONE_CAT_NAME_PERLINE = "Skriv inn et kategorinavn per linje";
	// Message
	var $LINKS_HAVE_BEEN_APRROVED = "%d linker er godkjent";
	...
	var $NO_RELATED_CATEGORY_ASSIGNED = "Det er ingen beslektede kategorier tildelt";
	...
	var $WRITABLE = "Skrivbar";
	var $NOT_WRITABLE = "IKKE skrivbar";
	var $IMAGES = "Bilder";
	var $FEATURES = "Funksjoner";
	var $NOTIFY = "Varsling";
	var $LANGUAGE = "Språk";
	var $LANGUAGES = "Språk";
	var $DEFAULT_TEMPLATE = "Standard mal";
	var $DEFAULT_MAP = "Standard kart";
	var $ADMIN_EMAIL = "Admins e-post";
	var $RESIZE_METHOD = "Metode for størrelsesendring";
	var $CATEGORY_IMAGE_SIZE = "Størrelse på kategoribilde";
	var $LISTING_IMAGE_SIZE = "Størrelse på oppføringsbilde";
	var $IMAGE_QUALITY = "Bildekvalitet";
	var $NETPBM_PATH = "Netpbm-sti";
	var $IM_PATH = "Imagemagick-sti";
	var $PRIMARY_ORDERING = "Overordnet rekkefølge";
	var $SECONDARY_ORDERING = "Underordnet rekkefølge";
	var $SHOW_EMPTY_CATEGORY = "Vis tomme kategorier";
	var $SHOW_ALPHA_INDEX = "Vis alfa-indeks";
	var $ALLOW_LISTINGS_SUBMISSION_IN_ROOT_CAT = "Tillat tillegging av oppføringer i indeks";
	var $SHOW_LISTINGS_IN_ROOT_CAT = "Vis oppføringer i indeks";
	var $SHOW_LISTING_COUNT_IN_ROOT_CAT = "Vis oppføringstelling i indeks";
	var $SHOW_CAT_COUNT_IN_ROOT_CAT = "Vis kategoritelling i indeks";
	var $SHOW_LISTING_COUNT_IN_SUBCAT = "Vis oppføringstelling i underkategorier";
	var $SHOW_CAT_COUNT_IN_SUBCAT = "Vis kategoritelling i underkategorier";
	var $SHOW_MAP = "Vis kart";
	var $SHOW_RATING = "Vis vurdering";
	var $SHOW_PRINT = "Vis skriv ut";
	var $SHOW_RECOMMEND = "Vis anbefal";
	var $SHOW_REPORT = "Vis rapport";
	var $SHOW_CLAIM = "Vis krav";
	var $CLAIM_EXPLAINATION = "Dette tillater registrerte brukere å gjøre krav på oppføringer og administrere dem under sin konto. Kun oppføringer fra administrator eller superadministrator kan bli gjort krav på. Brukere må være registrerte for å sende et krav.";
	var $SHOW_EMAIL = "Vis e-post";
	var $SHOW_REVIEW = "Vis omtale";
	var $SHOW_VISIT = "Vis besøk";
	var $SHOW_CONTACT = "Vis kontakt";
	var $USE_OWNER_EMAIL = "Bruk brukers e-postadresse om oppføringens e-post mangler";
	var $SHOW_OWNERS_LISTING = "Vis eiers oppføring";

	var $RATE_ONCE = "Brukere kan kun vurdere en gang";
	var $MIN_VOTES_FOR_TOPRATED = "Minimum antall stemmer som må til for topp vurdert oppføringer";
	var $MIN_VOTES_TO_SHOW_RATING = "Minimum antall stemmer før vurdering vises";
	var $REVIEW_ONCE = "Brukere kan kun omtale en gang";
	var $REGISTERED_ONLY = "Kun registrerte brukere";
	var $PUBLIC = "Offentlig";
	var $NONE = "Ingen";
	var $USER_RECOMMEND = "Anbefalingstilgang";
	var $USER_REVIEW = "Godkjenningstilgang";
	var $USER_RATING = "Vurderingstilgang";
	var $USER_ADDLISTING = "Hvem kan foreslå oppføringer";
	var $USER_ADDCATEGORY = "Hvem kan foreslå kategorier";
	var $USER_ALLOWMODIFY = "Tillat eier å endre oppføringer";
	var $USER_ALLOWDELETE = "Tillat eier å slette oppføringer";
	var $NEEDAPPROVAL_ADDLISTING = "Nye oppføringer krever godkjenning";
	var $NEEDAPPROVAL_ADDCATEGORY = "Nye kategorier krever godkjenning";
	var $NEEDAPPROVAL_MODIFYLISTING = "Endring av oppføringer krever godkjenning";
	var $NEEDAPPROVAL_ADDREVIEW = "Nye omtaler krever godkjenning";

	var $DAYS_NEWLISTING = "Antall dager å vise som ny oppføring";
	var $HITS_POPULARLISTING = "Antall treff for å vise på populær listen";
	var $SECONDS_NEXTVOTE = "Antall sekunder før neste treff registreres fra samme besøkende";
	var $ADMIN = "Admin";
	var $MODIFY_LISTING = "Endre oppføring";
	var $DELETE_LISTING2 = "Slett oppføring";
	var $NEW_REVIEW = "Ny omtale";
	var $LISTING_APPROVED = "Oppføring godkjent";
	var $REVIEW_APPROVED = "Omtale godkjent";
	var $USE_INTERNAL_NOTES = "Bruk interne notater";
	var $ALLOW_HTML = "Tillat HTML-tagger i beskrivelse";
	var $ALLOW_IMGUPLOAD = "Tillat eier å laste opp bilde";

	var $USE_EXPLORER = "Bruk utforsker";

	var $PERFORM_FULLTEXT_SEARCH = "Utfør fulltekst søk:";
	var $NOTIFY_CONFIGTEXT = "Du kan angi om det skal sendes e-postvarsel til admin og/eller eier ved følgende hendelser.";
	var $SEARCH_CONFIGTEXT = "Valgene under gir mulighet til å angi hvilke felt som skal søkes når besøkende utfører et enkelt søk i listen.";
	var $EXPLORER_CONFIGTEXT = "Deaktivering av utforsker i administrasjonen vil øke hastigheten når du har et stort antall kategorier. Instilling for listenivå vil begrense hvor mange nivåer utforsker eller fullmenyutforsker vil vise.";
	var $CONFIG_HAVE_BEEN_UPDATED = "Instillingene er oppdatert!";
	var $ERROR_UNABLE_TO_WRITE_CONFIG = "En feil har oppstått! Kan ikke åpne konfigurasjonsfilen for skriving!";
	var $CUSTOM_FIELDS_HAVE_BEEN_UPDATED = "Egendefinerte detaljer er oppdatert!";

	var $NUMBER_OF_SUBCATS = "Antall underkategorier";
	var $NUMBER_OF_CHARS = "Antall bokstaver i oppsummering";
	var $NUMBER_OF_LISTING = "Antall oppføringer per side";
	var $NUMBER_OF_REVIEWS = "Antall omtaler per side";
	var $NUMBER_OF_POPULAR = "Antall populære oppføringer per side";
	var $NUMBER_OF_NEW = "Antall nye oppføringer per side";
	var $TOTAL_OF_NEW = "Nye oppføringer totalt";
	var $NUMBER_OF_MOSTRATED = "Antall mest vurderte oppføringer per side";
	var $NUMBER_OF_TOPRATED = "Antall topp vurderte oppføringer per side";
	var $NUMBER_OF_MOSTREVIEW = "Antall mest omtalte oppføringer per side";
	var $NUMBER_OF_SEARCHRESULTS = "Antall søkeresulteter per side";
	var $NUMBER_OF_FEATURED = "Antall utvalgte oppføringer per side";

	/* About Mosets Tree */
	var $VERSION = "Versjon";
	var $AUTHOR = "Forfatter";
	var $LICENSE = "Lisens";
	var $DATE = "Dato";
