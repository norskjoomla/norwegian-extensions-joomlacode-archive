...
$GLOBALS["error_msg"] = array(
	...
	"abovehome"		=> "Den aktuelle katalogen kan ikke være over hjemkatalogen.",
	...
	"searchnothing"	=> "Søketema må angis.",

	// misc
	"miscnofunc"		=> "Funksjonen er ikke tilgjengelig.",
	"miscfilesize"	=> "Filen overskrider maksimal størrelse.",
...
$GLOBALS["messages"] = array(
	...
	'success_rename_file' => 'Katalogen/filen %s ble omdøpt til %s.',
	
	// actions
	"actdir"		=> "Katalog",
	"actperms"		=> "Endre rettigheter",
	"actedit"		=> "Redigere fil",
	"actsearchresults"	=> "Søkresultat",
	...
	"miscsubdirs"		=> "Søk i underkataloger",
	...
	'siphpupdate'		=> 'INFORMASJON: <span style="color: red;">PHP-versjonen du bruker er<strong>ikke</strong> gjeldende!</span><br />For å garantere at alle funksjoner og muligheter skal fungera,<br />bør du bruke minst <strong>PHP-versjon 4.3</strong>!',
	...
	'sidirpermsmess'	=> 'For å være sikker på at alle funksjoner og muligheter i eXtplorer skal fungere korrekt, skal følgende kataloger ha skrivrættigheter [chmod 0777]',
	'sionoff'		=> array( 'Av', 'På' ),
	...
	'ftp_connection_failed' => "Det gikk ikke å kopple opp mot FTP-serveren. \nKontroller om FTP-serveren kjører på din server.",
	'ftp_login_failed' 	=> "FTP-innloggingen feilet. Kontrollere brukernavn og passord og prøv igjen.",
	...
	'actlogin_failure' 	=> 'Innlogging mislykket, prøv igjen.',
