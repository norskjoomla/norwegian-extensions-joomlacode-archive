...
// 1.2 Frontend:
DEFINE('_UE_ERROR_USER_NOT_SYNCHRONIZED','Bruker, ikke eksisterende, eller ikke synkronisert med CB');
...
.'For å logge deg på kontoen din, kan du klikke på linken nedenfor:\n'
.'%s\n\n'
.'Takk.\n');
...
// 1.2 Backend:
DEFINE('_UE_TOP_AND_BOTTOM','Topp og bunn');
DEFINE('_UE_REG_SHOW_ICONS_EXPLAIN','Vis forklaring av ikonene');
DEFINE('_UE_REG_SHOW_ICONS_EXPLAIN_DESC','Om forklaringer på ikonene skal vises på toppen og / eller nederst på registreringssiden (standard er øverst og nederst)');
DEFINE('_UE_ICONS_DISPLAY','Vis ikoner på felt');
DEFINE('_UE_ICONS_DISPLAY_DESC','Hvorvidt ikoner og ikon forklaringer skal vises ved registrering og brukerredigerings sidene. Info ikoner er alltid vist hvis feltet beskrivelser er til stede.');
DEFINE('_UE_REG_SHOW_LOGIN_ON_PAGE','Vis pålogging på registreringssiden');
...
DEFINE('_UE_FB_TABTITLE', 'Forum innstillinger' );
DEFINE('_UE_FB_ORDERING_OLDEST', 'Eldste post først' );
DEFINE('_UE_FB_ORDERING_LATEST', 'Nyeste post først' );
DEFINE('_UE_FB_ORDERING_TITLE', 'Meldingssortering' );
...
DEFINE('_UE_PROFILE_GALLERY_MODERATION','Gallery Moderation');
...
DEFINE ('_UE_SHOWEMPTYFIELDS','Vis tomme felt');
...
// 1.2 CB RC 2 beta 2:
DEFINE('_UE_USERNAME_OR_EMAIL','Brukernavn eller epost');
