...
define("NBILL_PREV", "<< Previous");
define("NBILL_NEXT", "Next >>");
...
define("NBILL_PAGE_PREVIOUS", "< Previous");
define("NBILL_PAGE_NEXT", "Next >");
define("NBILL_PAGE_END", "End >>");
...
define("NBILL_MNU_POTENTIAL_CLIENTS_HELP", "Manage Potential Clients");
define("NBILL_MNU_PROFILE_FIELDS", "Client Profile Fields");
define("NBILL_MNU_PROFILE_FIELDS_HELP", "Define the core profile fields that will appear by default on each form (can also be customised on each form individually).");
define("NBILL_MNU_QUOTE_REQUEST", "Quote Request Forms");
define("NBILL_MNU_QUOTE_REQUEST_HELP", "Manage Quotation Request Forms");
define("NBILL_MNU_QUOTES", "Quotes");
define("NBILL_MNU_QUOTES_HELP", "Manage Quotations");
define("NBILL_MNU_PAYMENT_PLANS", "Payment Plans");
define("NBILL_MNU_PAYMENT_PLANS_HELP", "Manage Payment Plans");
...
define("NBILL_UNKNOWN_EMAIL_ERROR", "The failure reason was not reported by the CMS. Check that you are using valid e-mail addresses (from and to) and that your server is capable of sending e-mails.");
define("NBILL_LOST_PASSWORD", "Lost Password?");
define("NBILL_SECURITY_IMAGE_CHANGE", "[Change letter code]");
define("NBILL_FORM_PREVIOUS", "&lt;&lt; Previous");
