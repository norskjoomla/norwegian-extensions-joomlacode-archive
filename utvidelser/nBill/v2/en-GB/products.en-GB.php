...
define("NBILL_INSTR_DOWNLOAD_LOCATION_2", "The ABSOLUTE PATH to the 2nd download file (you can have up to 3 files, eg. you might want an extra tutorial document to accompany your main product). ");
...
define("NBILL_DELETE_DISCOUNT", "Delete Product Discount");
