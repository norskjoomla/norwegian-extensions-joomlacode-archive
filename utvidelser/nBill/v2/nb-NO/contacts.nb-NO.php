...
define("NBILL_INSTR_ADDRESS", "Optionally enter the address for this contact (it is only used to create the client or supplier address if a client or supplier record is generated based on this contact).");
...
//Version 1.2.0
define("NBILL_CONTACT_UNDER_MAMBOT_CONTROL", "This user`s access to the site is controlled by the user subscription mambot. You can click on this icon to remove all restrictions on this user`s access to your site.");
define("NBILL_CONTACT_CANCEL_MAMBOT_CONTROL", "Are you sure you want to remove this user from the control of the user subscription mambot?");
define("NBILL_CONTACT_MAMBOT_CONTROL_CANCELLED", "The selected user is no longer controlled by the user subscription mambot.");
