...
define("NBILL_INSTR_PAYMENT_PLAN_TYPE", "Velg type betalingsplan du behøver.<ul><li>'Forhåndsbetale' er standard hvor hele beløpet betales umiddelbart. </li><li>'Avdrag' deler det skyldige beløpet i vanlige betalinger med de intervaller definert under.</li><li>'Depositum, pluss endelig betaling' et fast beløp eller prosentandel umiddelbart og resten når brukeren velger når de skal betale mellomlegget (ingen ytterligere beløp trekkes automatisk).</li><li>'Depositum pluss avdrag' et fast beløp eller prosentandel umiddelbart, og resten delt i vanlige betalinger med intervaller du definerer nedenfor (den umiddelbare betalingen er ikke klassifisert som et avdrag).</li><li>'Utsatt betaling' ingen betaling nå, og venter til brukeren er klar til å betale.</li><li>'Brukerkontrollert' brukeren kan velge hvor mye du skal betale på forhånd (om noe), og gir dem mulighet til å betale resten (i flere delbetalinger ved behov) når de er klare.</li></ul>");
