...
//Vendors
define("NBILL_VENDOR_INTRO", "Typisk, du vil bare ha dine egne firmadetaljer listet her. Dersom du har mer enn et firma, eller en tilbyder for flere firmaer, kan du legge til ytterligere firmadetaljer. Alle fakturaer, inkludert oppføringer, blir lagret separat for hver leverandør.");
define("NBILL_VENDOR_DETAILS", "Leverandørdetaljer");
define("NBILL_NEW_VENDOR", "Ny leverandør");
define("NBILL_EDIT_VENDOR", "Rediger leverandørdetaljer");
...
define("NBILL_INSTR_VENDOR_COUNTRY", "Dette vil kun vises på automatisk genererte fakturaer når fakturadresse er i et annet land.");
...
define("NBILL_INSTR_NEXT_QUOTE_NO", "Legg inn neste tilbudsnummer som skal genereres (du kan velg alpha-numeriske karakterer i starten, men siste karakter må være numerisk, da denne økes automatisk).");
...
define("NBILL_INSTR_CLIENT_ORDERING", "Om komponentens 'brukerside' skal gi innloggede brukere rett eller ikke rett til å legge inn ordre ");
define("NBILL_INSTR_PUBLIC_ORDERING", "Om komponentens 'brukerside' skal gi ikke innloggede brukere rett eller ikke rett til å legge inn ordre ");
...
define("NBILL_VENDOR_ADDRESS_REQUIRED", "Du må spesifisere leverandørens adresse");
...
define("NBILL_INSTR_INVOICE_EMAIL_TEMPLATE", "Navn på HTML mal som brukes for å sende e-faktura tilkunden(eventuelt - se e-faktura alternativene nedenfor).");
define("NBILL_CREDIT_TEMPLATE", "Mal kreditnota");
define("NBILL_INSTR_CREDIT_TEMPLATE", "Navn på mal som brukes for å produsere kredit noter for denne leverandøren.");
define("NBILL_CREDIT_EMAIL_TEMPLATE", "E-post mal kreditnota");
define("NBILL_INSTR_CREDIT_EMAIL_TEMPLATE", "Navn på HTML mal som brukes for e-post kreditnotaer tilkundene (hvis aktuelt).");
define("NBILL_QUOTE_TEMPLATE", "Tilbudsmal");
define("NBILL_INSTR_QUOTE_TEMPLATE", "Navn på mal som brukes for å produsere tilbud for denne leverandøren.");
define("NBILL_QRC_EMAIL_TEMPLATE", "Mal tilbudsbekreftelse på e-post");
define("NBILL_INSTR_QRC_EMAIL_TEMPLATE", "Navn på HTML mal som brukes for e-postbekreftelse på tilbudsskjemaer til kunden (hvis aktuelt).");
define("NBILL_QUOTE_EMAIL_TEMPLATE", "E-post mal pristilbud");
define("NBILL_INSTR_QUOTE_EMAIL_TEMPLATE", "Navn på HTML mal som brukes for å sende pristilbud på e-post til kunden (hvis aktuelt).");
define("NBILL_PENDING_EMAIL_TEMPLATE", "E-post mal for ventende bestillinger");
define("NBILL_INSTR_PENDING_EMAIL_TEMPLATE", "Navn på HTML mal som brukes for å sende ventede ordrebekreftelse på e-post til kunden (hvis aktuelt – kan tilpasses for hvert bestillingsskjema).");
define("NBILL_ORDER_EMAIL_TEMPLATE", "E-post mal bestillinger");
define("NBILL_INSTR_ORDER_EMAIL_TEMPLATE", "Navn på HTML mal som brukes for å sende ordrebekreftelse på e-post til kunden (hvis aktuelt – kan tilpasses for hvert bestillingsskjema).");
...
define("NBILL_INSTR_SUPPRESS_RECEIPT_NOS", "Hvorvidt om man skal fjerne generering av kvitteringsnummer når inntektselementer er lagt til, og tilbyr en verktøylinjeknapp for å generere kvittering for alle inntekter eks. opp til en gitt dato i stedet. Dette er slik at du kan ha alle kvitteringstall i dato rekkefølge, selv om du har en blanding av automatisk genererte inntekter fra elektroniske betalinger og manuelt innlagte inntekter eks. (eg. for sjekker ets. som overføres direkte til bankkontoen din). Ved å sette denne til 'Ja', vil en ekstra verktøylinjeknapp vises på inntektslist-siden slik at du kan fylle ut kvitteringstallene opp til en gitt dato, når du er klar. ");
define("NBILL_VENDOR_LOGO", "Leverandørlogo");
define("NBILL_INSTR_VENDOR_LOGO", "Last opp en .png eller en .gif fil som vises på leverandørens faktura (hvis dette støttes av fakturamalen). Må være .png eller .gif og mindre enn 30 kb. OBS: Det er mulig du må oppdatere nettleservinduet, etter du har lastet opp et nytt bilde, siden noen nettlesere lagrer bildet i bufferet.");
define("NBILL_VENDOR_GIF_ONLY", "Beklager, filen som du lastet opp (%s) er ikke gyldig.  Kun GIF eller PNG filer kan brukes som leverandørlogo");
...
define("NBILL_INSTR_INVOICE_SMALL_PRINT_QU", "Skriv inn eventuelle juridiske ansvarsfraskrivelser etc. som du vil skal vises på pristilbudet.");
...
define("NBILL_SYNCHRONISATION_ERROR", "Det oppstod en feil mens du prøvde å laste opp til primærdatabasen. Opplasting avbrutt! Feilmeldingen som returneres av databasen var: ");
...
define("NBILL_VENDOR_DEFAULT", "Standard leverandør");
define("NBILL_INSTR_VENDOR_DEFAULT", "Hvis du har mer enn en leverandørpost, kan noen innstillinger på andre poster (f. eks land) være standard til verdien til standard leverandøren hvis ingen annen verdi er gitt og leverandøren ikke er kjent (for eksempel på nye kunder). Det bør alltid være en standard leverandør.");
...
define("NBILL_SYNC_SUCCESS", "Synkronisering fullført!");
define("NBILL_SYNC_SUCCESS_RECORD_COUNT", "%s1 post(er) satt inn, og %s2 post(er) oppdatert i hoveddatabasen");
define("NBILL_VENDOR_SYNC_RETRY", "Synkroniseringen av leverandørdata ble ikke fullført. Prøve på nytt fra der den stoppet, <a href=\"#\" onclick=\"%s;return false;\">Klikk her</a>.");
define("NBILL_VENDOR_SYNC_ABORT", "Avbryt");
define("NBILL_VENDOR_SYNC_ABORT_SURE", "Er du sikker på at du vil avbryte synkroniseringen av leverandører? Hoveddatabasen inneholder kanskje ikke alle data fra denne nettsiden hvis du gjør det.");
