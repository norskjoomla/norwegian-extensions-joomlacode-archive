...
define("NBILL_NOT_IN_DEMO_MODE", "Denne funksjonen er ikke tilgjengelig i demomodus");
...
define("NBILL_MNU_POTENTIAL_CLIENTS_DESC", "Administrere Potensielle kunder");
define("NBILL_MNU_PROFILE_FIELDS", "Kundeprofil");
define("NBILL_MNU_PROFILE_FIELDS_DESC", "Definer kjerneprofilfeltene som vises som standard på hvert skjema (kan også tilpasses i hvert enkelt skjema individuelt).");
define("NBILL_MNU_QUOTE_REQUEST", "Prisforespørselskjemaer");
define("NBILL_MNU_QUOTE_REQUEST_DESC", "Administrere prisforespørselskjemaer");
define("NBILL_MNU_QUOTES", "Prisforespørsel");
define("NBILL_MNU_QUOTES_DESC", "Administrere prisforespørsler");
define("NBILL_MNU_PAYMENT_PLANS", "Betalingsplaner");
define("NBILL_MNU_PAYMENT_PLANS_DESC", "Administrere betalingsplaner");
