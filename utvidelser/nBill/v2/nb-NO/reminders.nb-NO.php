...
define("NBILL_INSTR_REMINDER_ACTIVE", "Skal sendes e-post for denne påminnelsen?");
...
define("NBILL_INSTR_REMINDER_SEND_AFTER", "Skal det sendes påminnelse etter hendelsen? Vanligvis bare brukt på forfalte fakturaer - dvs. å sende en påminnelse x dager etter forfallsdato på faktura).");
...
define("NBILL_REMINDER_SENT_ERROR_NO_CLIENT", "ADVARSEL! Det oppstod en feil ved forsøk på å sende denne påminnelsen. Ingen kunde poster ble funnet. Påminnelse er ikke sendt.");
