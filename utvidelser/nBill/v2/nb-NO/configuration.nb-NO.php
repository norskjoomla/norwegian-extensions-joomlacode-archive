...
define("NBILL_CFG_LIST_USERS", "Liste opp brukere på klientsiden");
...
define("NBILL_CFG_INSTR_DATABASE_FUNCTIONS", "Komprimér eller slett " . NBILL_BRANDING_NAME . " tabellene. Komprimering av tabellene vil slette alle data så du kan starte på nytt igjen (du må angi lisenskoden på nytt). For å kunne slette komponenten fullstendig må du først slette tabellene før du avinstallerer komponenten. IKKE slett tabellene om du skal oppgradere til siste versjon av " . NBILL_BRANDING_NAME . " og beholde dataene! MERK: SLETTING AV TABELLENE GJØR " . strtoupper(NBILL_BRANDING_NAME) . " UBRUKELIG. Etter sletting bør du avinstallere komponenten, da den ikke lenger vil virke!");
define("NBILL_CFG_CLEAR_TABLES", "Komprimér tabellene");
