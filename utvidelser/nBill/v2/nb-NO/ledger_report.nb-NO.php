...
define("NBILL_LEDGER_REPORT_NET_AMOUNT", "Nettobeløp");
define("NBILL_LEDGER_REPORT_TAX_AMOUNT", "Avgiftsbeløp");
define("NBILL_LEDGER_REPORT_GROSS_AMOUNT", "Bruttobeløp");
...
define("NBILL_LEDGER_REPORT_TOTAL_EXPENDITURE", "Utgifter totalt (%s transaksjoner)");
define("NBILL_LEDGER_REPORT_PF_EXPANDED", "Utskriftsvennlig (Utvidet)");
define("NBILL_LEDGER_REPORT_PF_COLLAPSED", "Utskriftsvennlig (sammentrukket)");
define("NBILL_LEDGER_REPORT_PERCENTAGE", "Prosentvis");
define("NBILL_LEDGER_TX_COUNT", "(%s transaksjoner)");