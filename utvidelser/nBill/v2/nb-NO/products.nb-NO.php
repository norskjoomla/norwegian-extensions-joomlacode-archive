...
define("NBILL_INSTR_CARRIAGE_UNITS", "Den angitte forsendelsesavgift vil bli multiplisert med verdien for den valgte tjenesten for å beregne de totale transportkostnadene (for tyngre varer som koster mer å sende skriv inn en verdi som er større enn 1). Det er tillatt å bruke desimaler.");
...
define("NBILL_SUB_ACCESS_LEVEL", "Brukergruppe tilgangsnivå");
define("NBILL_INSTR_SUB_ACCESS_LEVEL", "Brukergruppe tilgangsnivå for brukere som kjøper dette abonnementet.");
