...
define("NBILL_CARRIAGE_INTRO", "Dette er valgfritt. Hvis du legger til fraktkostnader til prisen på produktene dine, kan du angi satsene her. Du kan også angi om transporten er MVA-pliktig, og i så fall bruke en annen sats av MVA for transportdelen av fakturaen.");
...
define("NBILL_INSTR_CARRIAGE_CODE", "Angi din egen kode for denne tjenesten (valgfritt, men brukes til å sortere leveringsmuligheter alfabetisk).");
...
define("NBILL_INSTR_CARRIAGE_IS_TAXABLE", "Indikér om det skal betales moms av fraktprisen");
