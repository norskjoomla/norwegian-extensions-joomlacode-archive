...
define("INV_TAX_SUMMARY_INTRO", "Denne rapporten viser totalt avgiftsbeløp som har blitt fakturert for en gitt datoperiode. Noen avgiftstype kan bare bli bokført etter at kunden har betalt for varen. Andre avgifter krever at du bokfører uansett om faktura er betalt eller ikke. Bruk radioknappen nedenfor for å velge hvilke av disse alternativene du vil bruke, angi datoperioden og klikk 'Start' for å få totalverdiene. Merk: Hvis du tar med ubetalte fakturaer, vil disse bare være med hvis datoen de ble laget faller innenfor den valgte datoperioden - det er derfor mulig at totalverdiene vil være lavere enn hvis du velger å ikke inkludere ubetalte fakturaer (som vil omfatte all fakturaer under den valgte perioden, selv om fakturaer ble laget før den valgte datoperiode).");
...
define("INV_TOTAL_TAXABLE", "Totalt skattbar inntekt");
...
define("INV_INSTR_TOTAL_NON_TAXABLE_DUE", "Dette er det totale beløpet fakturert for hvor det ikke skyldes avgifter (dette kan inkludere inntekter som ikke er knyttet til eventuelle fakturaer, f.eks. renter fra banken).");
...
define("INV_INSTR_GROSS_TOTAL_DUE_WO", "Totalt inntekter avskrevet, inkludert avgifter.");
define("INV_VAT_RPT_TOTAL_TAX_WO", "Totalt");
define("INV_VAT_RPT_TAX_NAME_WO", "Avgift");
define("INV_INSTR_VAT_RPT_TOTAL_TAX_DUE_WO", "Totalt avgifter avskrevet");
...
define("INV_VAT_RPT_DISCREPANCIES_WO", "ADVARSLE! Avvik funnet");
define("INV_INSTR_VAT_RPT_DISCREPANCIES_WO", "Fakturanumrene som er vist her synes å være manuelt endret slik at netto beløpet og avgifter ikke stemmer med brutto total for minst ett element på fakturaen, eller summen av de enkelte fakturaene ikke stemmer totalt for fakturaene. Dette betyr at tallene over kanskje ikke er riktig. Sjekk summen for hver av verdiene (netto, avgift, transport, transportavgift og brutto) på disse fakturaene og rette dem hvis nødvendig. Hvis du ikke kan se noe galt med fakturaene, prøver å lagre dem på nytt (dette vil føre til at tallene beregnes på nytt). Hvis du får denne meldingen etter å ha kontrollert og lagret fakturaen (e), kan fakturaen (e) være korrupt og i så fall må du slette dem å opprette dem manuelt (ved å gå til fakturalisten og klikke ’ny’ på verktøylinjeknappen).");
define("INV_TAX_SUMMARY", "SUMMARY (Bare for relevant for avgifter)");
define("GROSS_PROFIT_LOSS", "Brutto fortjeneste (eller tap)");
define("TAX_PAYABLE_REBATE_DUE", "Totalt betalbar avgift (eller rabatt skyldig)");
