...
define("INV_PAID_IN_FULL", "Betalt alt");
...
define("INV_INVOICE_ITEMS", "Faktura post");
...
define("INV_INSTR_INVOICE_SMALL_PRINT", "Juridiske informasjonen som kommer på fakturaen (f. eks renter hvis betalingen er forsinket).");
...
define("INV_INSTR_INVOICE_PARTIAL_PAYMENT", "Hvorvidt noe er betalt, men ikke alter betalt");
define("INV_INSTR_INVOICE_REFUND_IN_FULL", "");
define("INV_INSTR_INVOICE_PARTIAL_REFUND", "Hvorvidt noe er refundert, men ikke hele beløpet");
define("INV_ERR_REDIRECT_BACK", "Faktura er IKKE lagret. Prøv igjen senere eller skriv inn fakturanummer manuelt. Du blir omdirigert til den forrige siden - du må kanskje friske opp nettleseren din, men all data du har oppgitt bør fortsatt være tilstede.");
...
define("INV_ERR_TEMPLATE_NOT_FOUND", "<strong>Fakturamal '%s' ikke funnet!</strong> Sørg for at en gyldig faktura malfilen ligger på '%s'.");
define("INV_SELECT_VENDOR_FOR_PRINT", "Forhåndsvisning bare tilgjengelig når en leverandør er valgt");
...
define("INV_EMAIL_INVOICE_ALT_TEXT", "Du ser denne meldingen fordi din e-postklient ikke støtter HTML-meldinger (eller hvis du ser det fra 'useriøs e-post' mappen, HTML kan da ikke vises). For å se fakturaen din, kan du enten vise denne e-posten i HTML-modus, eller logg inn på %s for å se din faktura online.");
define("INV_EMAIL_INVOICE_NOTIFICATION", "Hei %s,\n\nDenne e-post er for å informere deg om at en ny faktura er sendt til deg.\n\n");
define("INV_INVOICE_EMAILED", "E-post");
define("INV_EMAIL_FAILED", "Et forsøk ble gjort for å sende en e-post, men det oppstod en feil som hindret e-post i å bli sendt. Kontroller serverkonfigurasjonen så den er i stand til å sende e-post.");
define("INV_EMAIL_FAILED_NO_ADDRESS", "Et forsøk ble gjort for å sende en e-post, men det ble ikke funnet en e-postadresse på denne kunden.");
define("INV_EMAIL_SENT", "E-post sent til  %s");
define("INV_EMAIL_NOT_DUE", "E-post sendes ikke (kundens innstillinger tillater ikke faktura via e-post).");
define("INV_EMAIL_NOW", "Send denne fakturaen til kunden via e-post nå");
define("INV_SEND_EMAIL", "Send e-post");
define("INV_SEND_EMAIL_INTRO", "Velg typen e-post som sendes (HTML eller ren tekst). Du kan også overstyre e-postadresse, navn og meldingstekst dersom du ønsker det ved å angi dine egne verdier her. Hvis du lar disse feltene stå tomte, " . INV_BRANDING_NAME . "vil informasjon fra kunderegisteret assosiert med denne fakturaen (hvis aktuelt), og standard meldingsteksten bli brukt.");
define("INV_SEND_EMAIL_MANY_INTRO", "Velg typen e-post som sendes (HTML eller ren tekst). Du kan også overstyre meldingsteksten ved å skrive din egen tekst her. Hvis du lar felt stå, " . INV_BRANDING_NAME . " vil standard melding bli brukt.");
define("INV_EMAIL_OPTIONS", "E-post alternativer");
...
define("INV_EMAIL_SENT_FAILURE", "En eller flere feil oppstod under forsøk på å sende e-post. Oppdater fakturalisten og deretter sjekke e-poststatus.");
define("INV_EMAIL_INVOICE_FOOTER_USERNAME", "Du kan se alle dine fakturaer elektronisk ved å logge deg på %s (ditt brukernavn er %s). Hvis du ikke lenger ønsker å motta fakturaer på e-post, kan du logge inn og klikke på `Min profil` på `Min konto` for å endre dine innstillinger.\n\nHilsen,\n%s");
...
define("INV_INSTR_WRITE_OFF_DATE", "Angi datoen som denne fakturaen ble avskrevet (hvis du har betalt avgift på dette angir du nedenfor at du ønsker å få tilbake denne, avgiftsrapporten vil beregne dette).");
...
define("INV_WRITTEN_OFF_DATE_REQUIRED", "Angi datoen når denne fakturaen ble avskrevet.");
...
define("INV_INSTR_INVOICE_TAX_RATE", "Standarden avgiftssats for å automatisk beregne avgiftengrunnlag på denne fakturaen (faktisk avgiftsbeløpet kan overstyres under)");
define("INV_INSTR_INVOICE_CARRIAGE_TAX_RATE", "Standard avgiftssats for transport, som brukes til automatisk å beregne avgiften på transport uavhengig av mengde på denne fakturaen (faktisk avgiftsbeløpet kan overstyres under)");
...
define("INV_AUTO_INVOICE_INTRO", "%s faktura(er) laget. Dato for når faktura ble laget: %s. Dato og klokkeslett: %s");
...
define("INV_AUTO_INVOICE_SUBJECT", INV_BRANDING_NAME . " Automatisk faktura laget");
define("INV_AUTO_INVOICE_FAILURE", "FEIL");
define("INV_AUTO_INVOICE_NO_LICENSE", INV_BRANDING_NAME . " Feil lisenskode eller ikke funnet");
define("INV_INVOICE_SHOW_PAYLINK", "Vis betalingslink?");
define("INV_INSTR_INVOICE_SHOW_PAYLINK", "Hvorvidt link 'Betal denne faktura' skal vises eller ikke. Verdien av den globale innstillingen avhenger av ordre antallet - hvis aktuelt - eller, visningsalternativene (Du kan angi en fast betalingsfrekvens - se visningsarternativene for mer informasjon). Betalingslinken vises bare hvis fakturaen ikke er betalt, og en standard betalingskanal er angitt på leverandøren, og brutto totalt på fakturaen er større enn null.");
