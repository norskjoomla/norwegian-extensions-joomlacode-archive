...
define("INV_USERNAME_PASSWORD_REQUIRED", "For å opprette en ny bruker, er både brukernavn og passord nødvendig");
...
define("INV_INSTR_CLIENT_COUNTRY", "Adresselinjen \"land\" (brukes for å bestemme avgiftssatsen hvis dette er relevant)");
...
define("INV_INSTR_CLIENT_REFERENCE", "Dette er din referanse som vises på kundens fakturaer - velg noe kort og enkelt som vil hjelpe deg å identifisere kunden.");
...
define("INV_INSTR_CLIENT_TAX_ZONE", "Hvis du har satt opp forskjellige avgiftsnivåer for ulike land, kan du angi avgiftskoden for denne kunden.");
define("INV_INSTR_CREDIT_AMOUNT", "Kreditt denne kunden kan ha på kontoen (netto etter avgift).");
define("INV_INSTR_CREDIT_TAX_AMOUNT", "Kreditt hos denne kunden som representerer avgift (for eksempel om det er blitt betalt formye og noe avgift må tilbakebetales).");
...
define("INV_INSTR_AUTO_DEDUCT", "Trekk beløpet automatisk fra neste faktura (bare hvis fakturaen er i samme valuta som kredittbeløpet).");
...
define("INV_INSTR_EMAIL_INVOICE_OPTIONS_CLIENT", "Spesifiser fakturavarsel når nye fakturaer genereres for denne kunden. <strong> Merk: </ strong> Hvis du sender automatisk e-post, er det sterkt anbefalt å sikre at alle kunder er tilknyttet brukere slik at de kan logge seg på nettsidens grensesnittkonfigurasjon å angi sine innstillinger og vise sine fakturaer. ");
