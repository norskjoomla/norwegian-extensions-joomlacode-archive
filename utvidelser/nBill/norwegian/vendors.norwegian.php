...
define("INV_INSTR_VENDOR_COUNTRY", "Dette vil kun vises på autogenererte fakturarer når fakturadresse er i et annet land.");
define("INV_INSTR_VENDOR_CURRENCY", "Velg valuta for denne leverandøren.");
define("INV_INSTR_VENDOR_OTHER_CURRENCIES", "Spesifiser annen valuta som kunder av denne leverandøren kan bestille og bli fakturert i (press Ctrl for flere valg, eller for å ta bort allerede valg).");
define("INV_INSTR_NEXT_INVOICE_NO", "Legg inn neste fakturanummer som skal genereres (Du kan velg alpha-numeriske karakterer i starten, men siste karakter må være numerisk, da denne automatisk vil økes).");
define("INV_INSTR_NEXT_ORDER_NO", "Legg inn neste ordrenummer som skal genereres (Du kan velg alpha-numeriske karakterer i starten, men siste karakter må være numerisk, da denne automatisk vil økes).");
define("INV_INSTR_NEXT_RECEIPT_NO", "Legg inn neste kviteringsnummer som skal genereres (Du kan velg alpha-numeriske karakterer i starten, men siste karakter må være numerisk, da denne automatisk vil økes).");
define("INV_INSTR_NEXT_PAYMENT_NO", "Legg inn neste betalingsnummer som skal genereres (Du kan velg alpha-numeriske karakterer i starten, men siste karakter må være numerisk, da denne automatisk vil økes).");
define("INV_INSTR_NEXT_CREDIT_NO", "Legg inn neste kreditt notatnummer som skal genereres (Du kan velg alpha-numeriske karakterer i starten, men siste karakter må være numerisk, da denne automatisk vil økes).");
define("INV_INSTR_DEFAULT_PAYMENT_INSTR", "Legg inn standard betalingsinnstruksjoner som skal vises på fakturane (dette kan endres for forskjellige land på skatte siden)");
define("INV_INSTR_DEFAULT_SMALL_PRINT", "Legg inn standard small print som skal vises på fakturane (dette kan endres for forskjellige land på skatte siden)");
...
define("INV_INSTR_SHOW_EMPTY_CATS", "Hvis brukere kan legge inn ordre ved komponentens 'front end', avgjør dette valget om det skal vises eller ikke vises kategorier som ikke inneholder produkter eller underkategorier");
define("INV_VENDOR_NAME_REQUIRED", "Du må ha et navn for leverandøren.");
define("INV_VENDOR_ADDRESS_REQUIRED", "Du må spesifisere leverandør addresse");
define("INV_VENDOR_COUNTRY_REQUIRED", "Du må spesifisere leverandør land .");
define("INV_VENDOR_CURRENCY_REQUIRED", "Du må spesifisere valutta som leverandør bruker.");
define("INV_VENDOR_EMAIL_REQUIRED", "Du må spesifisere leverandør e-post adresse.");
define("INV_ERR_CANNOT_DELETE_LAST_VENDOR", "Du kan ikke slette siste leverandør!");
define("INV_INVOICE_NO_LOCKED", "Neste faktura nummer for leverandøren er låst for øyeblikket. Dette skal kun skje midlertidig mens fakturaer blir generert. Hvis faktura generering feiler og dette feltet fortsatt er låst, kan du låse opp ved å trykke på denne knappen:");
define("INV_ORDER_NO_LOCKED", "Neste ordre nummer for leverandøren er låst for øyeblikket. Dette skal kun skje midlertidig mens fakturaer blir generert. Hvis faktura generering feiler og dette feltet fortsatt er låst, kan du låse opp ved å trykke på denne knappen:");
define("INV_RECEIPT_NO_LOCKED", "Neste kvitterings nummer for leverandøren er låst for øyeblikket. Dette skal kun skje midlertidig mens fakturaer blir generert. Hvis faktura generering feiler og dette feltet fortsatt er låst, kan du låse opp ved å trykke på denne knappen:");
define("INV_PAYMENT_NO_LOCKED", "Neste betalings nummer for leverandøren er låst for øyeblikket. Dette skal kun skje midlertidig mens fakturaer blir generert. Hvis faktura generering feiler og dette feltet fortsatt er låst, kan du låse opp ved å trykke på denne knappen:");
define("INV_UNLOCK", "Unlock");
define("INV_INVOICE_TEMPLATE", "Faktura mal");
define("INV_INSTR_INVOICE_TEMPLATE", "Navn på mal som skal brukes for produksjons fakturane fra denne leverandøren.");
...
define("INV_INSTR_DEFAULT_GATEWAY", "Standard betalingsmåte som brukes for nye ordreskjemaer og for å tillate betaling av fakturaer på nett (hvis det er aktuelt).");
...
define("INV_INSTR_SUPPRESS_RECEIPT_NOS", "Om man skal, eller ikke fjerne generering av kvitteringstall når inntekts elementer er lagt til, og tilbyr en verktøylinjeknapp for å generere kvittering for alle inntekter eks. opp til en gitt dato i stedet. Dette er slik at du kan ha alle kvitteringstall i dato rekkefølge, selv om du har en blanding av automatisk genererte inntekter fra elektroniske betalinger og manuelt innlagte inntekter eks. (eg. for sjekker ets. som overføres direkte til bankkontoen din). Ved å sette denne til \"Ja\", vil en ekstra verktøylinjeknappen vises på inntektslist siden slik at du kan fylle ut kvitteringstallene opp til en gitt dato, når du er klar. ");
define("INV_VENDOR_LOGO", "Leverandør logo");
define("INV_INSTR_VENDOR_LOGO", "Last opp en .gif fil som vises på leverandørs faktura (hvis dette støttes av fakturamal. Må være .gif og mindre enn 30k). NOTE: Det er mulig du må oppdatere nettleservinduet, etter du har lastet opp et nytt bilde, siden noen nettlesere lagrer bildet i bufferet (f.eks.. firefox).");
define("INV_VENDOR_GIF_ONLY", "Beklager, logo fila som du lastet opp (%s) er ikke gyldig.  Kun GIF filer kan brukes som levarandør logo");
define("INV_VENDOR_GIF_TOO_BIG", "Beklager, logo fila du lastet opp er for stor. Maks str. er 30k");
define("INV_DELETE_LOGO", "Slett");
define("INV_VENDOR_DELETE_LOGO_FAILED", INV_BRANDING_NAME . " kunne ikke slette logo fila. Det kan være fordi PHP ikke har rettigheter til å slette filer på din server.");
define("INV_SUPPRESS_PAYMENT_NOS", "Generer betalings nummer manuelt?");
define("INV_INSTR_SUPPRESS_PAYMENT_NOS", "Som over, men for betalings nummer på utgiftslista.");
define("INV_ADD_REMITTANCE", "Vis remisse råd?");
define("INV_INSTR_ADD_REMITTANCE", "Om det skal legges til eller ikke en remisse råd slip på slutten av fakturaer.");
...
define("INV_MASTER_DB_INTRO", "Hvis du selger produkter eller arbeid ved bruk av flere nettsider, hver og en med kopi av " . INV_BRANDING_NAME . ", men du ønsker ha all finans informasjon kun på en av nettsidene, kan du gjøre dette ved å bruke en kjede av 'master' databaser. VIKTIG! Vennligst ikke bruk denne muligheten før da har lest dokumentasjonen (tiljengelig på " . INV_BRANDING_NAME . " nettsiden), ellers er mulighetene tilstede for at du ødelegger dataene!");
...
define("INV_SYNC_ARE_YOU_SURE", "ADVARSEL! Dette vil overskrive data på master database (r). Klikk OK for å laste opp data, eller Avbryt for å avbryte.");
define("INV_MASTER_DB_TEST_SUCCESS", "Koblet til Hoveddatabase");
define("INV_MASTER_DB_NOT_IN_USE", "Kan ikke oppdatere hoveddatabasen - du må sette 'bruk hoveddatabase' til 'Ja' før du forsøker å laste opp.");
define("INV_SYNCHRONISATION_ERROR", "Det oppstod en feil mens du prøver å laste opp til master database. Opplasting avbrutt! Feilmeldingen som returneres av databasen var: %s");
define("INV_SYNCHRONISE_RECORD_COUNT", "%s Oppføring(er) lagt til, og %s Oppføring(er) oppdatert i Hoveddatabasen");
define("INV_SYNCHRONISE_NEED_GEN", "KAN IKKE FORTSETTE! En eller flere inntekter eller utgiftsposter (enten på denne databasen, eller på en hoveddatabase) har ennå ikke fått tildelt et nummer. Du må generere betaling og/ eller kvitteringstall før synkronisering (generering av kvittering eller betalingstall på denne databasen vil også generere eventuelle utestående på hoveddatabase(ne)).");
...
define("INV_INSTR_SUPPRESS_GENERATION_BUTTONS", "Om å fjerne, eller ikke fjerne visning av verktøylinjeknappene for å tillate betalings/ kvitterings nummer generering. Du bør bare angi dette til \"Ja\" hvis dette er en hoveddatabase, som har et underdatabase som nummer generering bør utføres (se hoeveddatabase avsnittet nedenfor). Hvis du angir en underddatabase til å bruke dette eksemplaret av " . INV_BRANDING_NAME . " som en master, vil verdien bli satt til \"Ja\" automatisk. DU GJØR DERFOR VANLIGVIS IKKE NOE MED INNSTILLINGENE med mindre du pleide å ha en underdatabase som peker til denne, men som ikke lenger finnes (da må du endre den fra \"Ja\" til \"Nei\" ).");
define("INV_ADD_PAYLINK", "Vis betalings link på fakturaer?");
