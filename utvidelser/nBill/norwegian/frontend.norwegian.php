...
define("INV_ERR_PENDING_ORDER_NOT_FOUND", "Et forsøk ble gjort for å laste en pågående bestilling (ordre id: %s), men bestillingen kan ikke lastes. All behandling av denne bestillingen er avbrutt – kan være nødvendig at en administrator oppretter brukerkonto, kundekonto,  bestilling og faktura.");
