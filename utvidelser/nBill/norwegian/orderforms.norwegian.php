...
define("INV_INSTR_FORM_BORDER", "Vise en ramme rundt celler i skjemaet.");
...
define("INV_FORM_PREREQ_SELECTED_PROD", "Valgdte produkt(er)");
...
define("INV_FORM_EMAIL_ADMIN", "Send ordren på epost til administrator?");
