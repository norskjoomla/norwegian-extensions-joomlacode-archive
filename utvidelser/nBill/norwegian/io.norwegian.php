...
//Import/Export
define("INV_IMPORT", "Importér");
define("INV_EXPORT", "Eksportér");
...
define("INV_IMPORT_CLIENTS_CSV_HELP_TEXT_4", "Dersom det ikke er noen 'bruker_id' kolonne, og ikke noen eksisterende bruker samsvarer med oppføringens e-postadresse men det er en 'brukernavn'-kolonne og en 'passord'-kolonne, vil " . INV_BRANDING_NAME . " opprette en ny bruker, og assosiere denne med kundeoppføringen. Dersom verdien i 'passord'-kolonnen er 32 tegn lang, og er mulig å dekode i base64 (dvs. bare alfanumerisk), antas det at passordet allerede har MD5-nøkler, og det vil ikke bli kodet på nytt. Du kan derfor velge å bruke MD5-kodede passord eller rpassord med ren tekst, og begge vil bli importert riktig. Det er likevel tryggere å alltid bruke MD5-kodede passord.");
define("INV_IMPORT_CLIENTS_CSV_HELP_TEXT_5", "Hvis det finnes en 'land'-kolonne i CSV-filen, må verdiene være som 2-tegns ISO-kode. Finnes ikke denne kolonnen, eller verdien er blank vil kundeoppføringen(e) bli satt til samme land som den valgte forhandleren.");
define("INV_IMPORT_ALL_USERS", "Importér alt");
define("INV_IMPORT_SELECT_USERS", "Velg brukere");
define("INV_IMPORT_CSV", "Importer CSV-fil");
define("INV_EXPORT_CLIENTS_CSV", "CSV-fil");
define("INV_INSTR_EXPORT_CLIENTS_CSV", "Eksportér kundeoppføringer til en CSV-fil.");
define("INV_EXPORT_CSV", "Last ned CSV-fil");
define("INV_INSTR_IMPORT_CLIENTS_VENDOR", "Velg forhandleren du ønsker å importere kundeoppføringer fra.");
define("INV_INSTR_EXPORT_CLIENTS_VENDOR", "Velg forhandleren du ønsker å eksportere kundeoppføringer for.");
