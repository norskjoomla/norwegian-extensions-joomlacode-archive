...
define("INV_PRODUCTS_INTRO", "Dette er en liste over produkter eller tjenester som en kan fakturere.");
...
define("INV_PATH_TO_IMAGE", "Nettadresse til bilde");
...
define("INV_NET_PRICE_BIANNUALLY", "Netto pris 2-årlig");
define("INV_NET_PRICE_FIVE_YEARLY", "Netto pris 5-årlig");
define("INV_NET_PRICE_TEN_YEARLY", "Netto pris 10-årlig");
...
define("INV_INSTR_IS_FREEBIE", "Hvis dette produktet leveres gratis, angi det her, ellers fylle inn en eller flere av prisboksene nedenfor.");
define("INV_INSTR_NET_PRICE_ONE_OFF", "Hvis dette produktet skal kjøpes direkte (snarere enn å betalt for med jevnelige mellomrom), angir netto pris her.");
define("INV_INSTR_NET_PRICE_WEEKLY", "Hvis produktet skal betales for hver uke, skriver inn netto pris per uke.");
define("INV_INSTR_NET_PRICE_MONTHLY", "Hvis produktet skal betales for månedlig, skriver inn netto pris per måned.");
define("INV_INSTR_NET_PRICE_QUARTERLY", "Hvis produktet skal betales for kvartalsvis, skriver inn netto pris per kvartal.");
define("INV_INSTR_NET_PRICE_ANNUALLY", "Hvis produktet skal betales for årlig, skriver inn netto pris per år.");
define("INV_INSTR_NET_PRICE_BIANNUALLY", "Hvis produktet skal betales for hvert andre år, skriver inn netto pris per 2 år.");
define("INV_INSTR_NET_PRICE_FIVE_YEARLY", "Hvis produktet skal betales for hvert femte år, skriv inn netto pris per 5 år.");
define("INV_INSTR_NET_PRICE_TEN_YEARLY", "Hvis produktet skal betales for hvert tiende år, skriv inn netto pris per 10 år.");
define("INV_INSTR_IS_TAXABLE", "Velg 'Nei' hvis du alltid vil utelate skatt for dette produktet, ellers velg 'ja'.");
define("INV_INSTR_REQUIRES_CARRIAGE", "Hvorvidt forsendelsesavgift skal legges på prisen for dette produktet eller ikke.");
...
define("INV_INSTR_DOWNLOAD_LOCATION", "Den absolutt sti til nedlastingsfilen (f. eks /hjem/brukernavn/filer/mittdokument.pdf). Denne plasseringen bør ikke være i den offentlige delen av nettstedet ditt. (dvs. Ikke bruk en mappe under din public_html eller htdocs mappe, ellers kan alle laste det ned uten å betale!)");
define("INV_INSTR_DOWNLOAD_LINK_TEXT", "Tekst som skal vises som nedlastningslink.");
...
define("INV_PRODUCT_PRICE_INTRO", "Angi prisen(e) på produktet i hver valuta som du ønsker å selge dette produktet i.");
define("INV_DOWNLOAD_INFO_REQUIRED", "Du har angitt at dette er et nedlastbart produkt, men har ikke oppgitt enten laste ned eller koblingsteksten. Kontroller at begge disse verdiene er angitt dersom du ønsker dette produktet skal være nedlastbare.");
define("INV_DOWNLOAD_LOCATION_2", "Nedlastingssted 2");
define("INV_INSTR_DOWNLOAD_LOCATION_2", "Den absolutt sti til 2. nedlastingsfilen (du kan ha opptil 3 filer). ");
define("INV_DOWNLOAD_LINK_TEXT_2", "Tekst på 2. nedlastningslink");
define("INV_INSTR_DOWNLOAD_LINK_TEXT_2", "Tekst som skal vises som 2. nedlastningslink.");
define("INV_DOWNLOAD_LOCATION_3", "Nedlastingssted 3");
define("INV_INSTR_DOWNLOAD_LOCATION_3", "Den absolutt sti til 3. nedlastingsfilen.");
define("INV_DOWNLOAD_LINK_TEXT_3", "Tekst på 3. nedlastningslink");
define("INV_INSTR_DOWNLOAD_LINK_TEXT_3", "Tekst som skal vises som 3. nedlastningslink.");
...
define("INV_INSTR_EXPIRY_LEVEL", "Hva skal du gjøre med brukerens privilegier når abonnement utløper (merk: Om kjøpet er en engangsbetaling vil abonnementet aldri utløpe).");
...
define("INV_PRODUCT_DISCOUNT_INTRO", "Du kan eventuelt angi at visse rabatter gjelder for disse produktene. Hvis mer enn én rabatt er aktuelt, bruk prioritetsverdien til å indikere hvilken som skal brukes først (Rabatt med prioritet på 0 vil bli brukt før en rabatt med prioritet på 1). Prioriteringer tildelt her overstyrer eventuelle prioriteringer satt andre plasser. For å kontrollere egenskapene på rabatten (f. eks beløpet, om den er eksklusiv, etc.), redigere rabatt via rabatt siden. Hvis du bare vil at rabatt skal gjelde når et bestemt antall av produktet er kjøpt, kan du angi dette i minimumsfeltet. Du kan også eventuelt multiplisere mengden rabatt ved mengde bestilt (rabatt bare på spesifikke fastprisprodukter). Hvis du bruker kvantum som multiplikator, kan du også spesifisere en korreksjon som skal trekkes fra multiplikatormetoden - f. eks, hvis du vil at rabatten bare skal gjelde for den 2. og etterfølgende antallet, men ikke for den første settes utlignet til 1.");
...
define("INV_INSTR_NET_PRICE_FOUR_WEEKLY", "Hvis produktet kan betales for hver 4. uke, skriver nettopris per fire uker.");
