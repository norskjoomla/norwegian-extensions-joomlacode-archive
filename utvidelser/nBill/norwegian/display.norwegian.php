...
define("INV_DISPLAY_RENEW_ADVANCE_LIMIT_DESC", "Maximum number of payment cycles in advance a renewal can be made (only applicable if `show renewal link` is set to `yes`. For example, if the payment frequency of an order is monthly, and you enter a value of 3 here, orders that are have auto-renew turned off will allow the user to manually renew up to 3 months in advance. If you enter 0 (zero) here, the renewal link will not appear until AFTER the due date.");
