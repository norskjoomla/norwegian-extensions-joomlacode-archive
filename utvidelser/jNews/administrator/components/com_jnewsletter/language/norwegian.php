...
//since 5.0.0
//mary for columns
define('_JNEWS_MCOLUMN1','Column 1');//$GLOBALS[ACA.'column1_name']);
define('_JNEWS_MCOLUMN2','Column 2');//$GLOBALS[ACA.'column2_name']);
define('_JNEWS_MCOLUMN3','Column 3');//$GLOBALS[ACA.'column3_name']);
define('_JNEWS_MCOLUMN4','Column 4');//$GLOBALS[ACA.'column4_name']);
define('_JNEWS_MCOLUMN5','Column 5');//$GLOBALS[ACA.'column5_name']);
//fieldset for column configuration
define('_JNEWS_COLUMN','User-defined Columns');
define('_JNEWS_COLUMN1','Show Column 1');
define('_JNEWS_COLUMN2','Show Column 2');
define('_JNEWS_COLUMN3','Show Column 3');
define('_JNEWS_COLUMN4','Show Column 4');
define('_JNEWS_COLUMN5','Show Column 5');
...
define('_JNEWS_SHOW_COLUMN1_TIPS','Show/hide this column in your subscribers list-BE');
define('_JNEWS_SHOW_COLUMN2_TIPS','Show/hide this column in your subscribers list-BE');
define('_JNEWS_SHOW_COLUMN3_TIPS','Show/hide this column in your subscribers list-BE');
define('_JNEWS_SHOW_COLUMN4_TIPS','Show/hide this column in your subscribers list-BE');
define('_JNEWS_SHOW_COLUMN5_TIPS','Show/hide this column in your subscribers list-BE');
define('_JNEWS_INPUT_COLUMN1','Column 1');//$GLOBALS[ACA.'column1_name']);
define('_JNEWS_INPUT_COLUMN2','Column 2');//$GLOBALS[ACA.'column2_name']);
define('_JNEWS_INPUT_COLUMN3','Column 3');//$GLOBALS[ACA.'column3_name']);
define('_JNEWS_INPUT_COLUMN4','Column 4');//$GLOBALS[ACA.'column4_name']);
define('_JNEWS_INPUT_COLUMN5','Column 5');//$GLOBALS[ACA.'column5_name']);
define('_JNEWS_INPUT_COLUMN1_TIPS','Enter your column 1');
define('_JNEWS_INPUT_COLUMN2_TIPS','Enter your column 2');
define('_JNEWS_INPUT_COLUMN3_TIPS','Enter your column 3');
define('_JNEWS_INPUT_COLUMN4_TIPS','Enter your column 4');
define('_JNEWS_INPUT_COLUMN5_TIPS','Enter your column 5');
define('_JNEWS_COLUMN1_REP', '[COLUMN1] = This will be replaced by your user defined column 1');
define('_JNEWS_COLUMN2_REP', '[COLUMN2] = This will be replaced by your user defined column 2');
define('_JNEWS_COLUMN3_REP', '[COLUMN3] = This will be replaced by your user defined column 3');
define('_JNEWS_COLUMN4_REP', '[COLUMN4] = This will be replaced by your user defined column 4');
define('_JNEWS_COLUMN5_REP', '[COLUMN5] = This will be replaced by your user defined column 5');
define('_JNEWS_REGWARN_COLUMN1','Please enter your');
define('_JNEWS_REGWARN_COLUMN2','Please enter your');
define('_JNEWS_REGWARN_COLUMN3','Please enter your');
define('_JNEWS_REGWARN_COLUMN4','Please enter your');
define('_JNEWS_REGWARN_COLUMN5','Please enter your');
//end of columns
//url
...
define('_JNEWS_LIST_T_ADMIN_NOTIFICATION' , 'Admin Notification');
