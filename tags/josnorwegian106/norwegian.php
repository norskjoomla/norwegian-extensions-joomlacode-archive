...
DEFINE('_CMN_IFRAMES', 'Denne funksjonen vil ikke fungere skikkelig. Din nettleser støtter ikke inline rammer');
...
/** poll.php */
DEFINE('_ALERT_ENABLED','Informajsonskapsler (cookies) må være aktivert!');
...
DEFINE('_AND', ' og ');
DEFINE('_GUEST_COUNT','$guest_array gjest');
DEFINE('_GUESTS_COUNT','$guest_array gjester');
DEFINE('_MEMBER_COUNT','$user_array bruker');
...
DEFINE('_MAINMENU_HOME','* Den første publiserte artikkelen er denne menyen [hovedmeny] er standard forside for nettsiden *');
