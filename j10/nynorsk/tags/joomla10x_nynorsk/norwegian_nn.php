...
DEFINE('_AND', ' og ');
DEFINE('_GUEST_COUNT','$guest_array gjestar');
DEFINE('_GUESTS_COUNT','$guest_array gjestar');
DEFINE('_MEMBER_COUNT','$user_array brukarar');
DEFINE('_MEMBERS_COUNT','$user_array brukarar');
