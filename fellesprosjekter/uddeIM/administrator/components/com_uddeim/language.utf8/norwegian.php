...
// *******************************************************************
// Language file: Norwegian (source file is Utf-8)
...
DEFINE ('_UDDEADM_TRANSLATORS_CREDITS', 'Karl-Gustav Freding, Christian Segura and <a href="http://villtur.org" target="_new">villtur.org</a>');	// Empty for English and German language files, enter your credits line here, e.g. 'Translation by <a href="http://domain.com" target="_new">John Doe</a>'
...
DEFINE ('_UDDEADM_VERSIONCHECK_EXP', 'Dette kontakter uddeIMs utviklernettsted for å motta informasjon om siste uddeIM-versjon. Bortsett fra uddeIM-versjonen du bruker, blir det ikke sendt annen informasjon.');
