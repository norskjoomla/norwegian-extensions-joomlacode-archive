...
//Installation
define("INV_INSTALL_COMPLETE", INV_BRANDING_NAME . " er ferdig installert.");
define("INV_DB_ERRORS", INV_BRANDING_NAME . " ble installert, men en eller flere databasefeil oppstod under installasjonen. Feilene vises nedenfor.");
define("INV_CANNOT_UPGRADE", "Beklager, du kan ikke oppgradere fra en versjon lavere enn 1.1.0. Vennligst avinstaller denne versjonen og installer deretter 1.1.0 for å oppdatere din database, deretter kan du forsøke å oppgradere til denne versjonen igjen.");
define("INV_UPGRADED_SUCCESSFULLY", "Din installasjon av " . INV_BRANDING_NAME . " ble vellykket oppgradert.");
...
//Licensing
define("INV_LICENSE_INVALID", "Din lisensnøkkel er ikke gyldig. Den kan ha utløpt, eller er ugyldig for domenet du forsøker å bruke den på. Vennligst kontakt " . INV_BRANDING_COMPANY . " for en gyldig lisensnøkkel for dette domenet. MERK: Om du skiver feil lisensnøkkel mer enn 12 ganger, vil du bli utestengt! Vennligst kontakt brukerstøtte om din nøkkel ikke virker.");
define("INV_NEW_LICENSE_KEY", "Skriv ny lisensnøkkel her:");
...
define("INV_NO_EXPIRY", "Lisens utløper ikke. Du har en livstidslisens");
...
define("INV_LOCKED_OUT_DESC", "Du har forsøkt å få tilgang til komponenten for mange ganger med ugyldig nøkkel. Komponenten er derfor blitt blokkert. For å låse den opp igjen, trenger du en opplåsingsnøkkel som skal skrives inn nedenfor. Denne kan du få ved å sende en e-post til: " . INV_BRANDING_SUPPORT_EMAIL . ", og sitere referanse '%s', samt oppgi ditt domenenavn (%s)");
define("INV_UNBLOCK_KEY", "Opplåsingsnøkkel");
define("INV_UNBLOCK_KEY_INVALID", "Beklager, denne opplåsingsnøkkelen er ugyldig.");
define("INV_LICENSE_EXPIRED", "Din lisens utløp %s");
define("INV_BLACKLISTED", "Ditt domenenavn har blitt svartelistet (en vanlig grunn til dette kan være at betaling ble kansellert etter bestilling). Du har ikke tillatelse til å fortsette. Vennligst kontakt oss om du mener dette er en feil.");
...
define("INV_ERR_COULD_NOT_GET_NEXT_NO", "Komponenten kunne ikke identifisere neste %s-nummer fordi databasefeltet for øyeblikket var låst av en annen prosess. Om problemet vedvarer, kan du låse opp %s-nummerfeltet ved å redigere selgeroppføringen.");
...
define("INV_SAVE_CHANGES", "Du har endret data uten å lagre på denne siden. Klikk OK, om du ønsker å lagre før du går videre. Klikk Avbryt om du ønsker å gå videre uten å lagre");  //Don't use apostrophes or speech marks in this text
define("INV_SELECT", "Velg");
define("INV_DESELECT", "Fjern fra utvalg");
...
define("INV_EMAIL_NOTIFICATION", "Send e-post til kunde (ren tekst) med instrukser om å logge på siden)");
...
define("INV_NUMERIC_ONLY", "Feltet `%s` krever en numerisk verdi. Du kan bare skrive inn tall her.");
define("INV_INVALID_DATE_FIELD", "Feltet `%s` krever en dato. Vennligst skriv inn dato med dette formatet: %s.");
define("INV_ERR_SERIOUS_ERROR", "Beklager, en feil har oppstått. En e-post som beskriver feilen er sendt til administrator. Beklager denne hendelsen.");
define("INV_ERR_SERIOUS_ERROR_ADMIN", "Beklager, en feil har oppstått. En e-post som beskriver feilen er sendt til administrator (som definert på konfigurasjonssiden til " . INV_BRANDING_NAME . "). Beklager denne hendelsen.");
define("INV_ERR_SERIOUS_ERROR_NOMAIL", "Beklager, en feil har oppstått. Komponenten kunne ikke sende en e-post som inneholder opplysninger om feilen til riktig person. Vennligst kontakt eieren av nettstedet (%s), og informer om denne feilen (som er registrert i deres database og/eller PHP-feillogg). Beklager denne hendelsen.");
define("INV_ERR_SERIOUS_ERROR_NOMAIL_ADMIN", "Beklager, en feil har oppstått. Komponenten var ikke i stand til å sende en e-post som inneholder opplysninger om feilen til riktig person (som definert på konfigurasjonssiden til " . INV_BRANDING_NAME . "). Siden denne feilen oppstod i kontrollpanelet, er detaljer om feilen angitt nedenfor. Beklager denne hendelsen.");
...
define("INV_ERR_MASTER_DB_LOOP", "PROSESS BLE STOPPET! Du synes å ha en løkke av hoveddatabaser. Sjekk at det for hver database bare er en hoveddatabase.");
...
define("INV_CSV_DOWNLOAD", "Last ned CSV-fil");
define("INV_CSV_DOWNLOAD_DESC", "Last ned denne rapporten som en CSV-fil (som kan åpnes i et regneark f.eks. MS Excel, eller importerer inn i et annet program)");
...
define("INV_EMAIL_INVOICE_OPTIONS", "Fakturavarsel");
define("INV_NOMINAL_LEDGER_CODE", "Hovedbokskode");
define("INV_INSTR_NOMINAL_LEDGER_CODE", "");
define("INV_ENTER_OVERRIDE_DATE", "Skriv inn dato (YYYY/MM/DD) opp til den dato du vil lage fakturaer for. Ingen faktura blir laget for bestillinger etter denne dato."); //Need to keep this quite short, as it is used in a javascript prompt which is a fixed size in IE
...
define("INV_INSTR_TAX_REFERENCE_DESC", "Skriv inn et beskrivende navn på avgiftsnummeret (f.eks. 'moms nr.')");
define("INV_INSTR_TAX_ABBREVIATION", "Skriv inn den vanlige forkortelsen for denne typen avgift (f.eks. MVA)");
define("INV_TAX_REFERENCE_NO", "Avgiftsreferansenummer");
define("INV_INSTR_TAX_REFERENCE_NO", "Skriv inn ditt firmas avgiftsnr. (f.eks. ditt MVA-nummer), inkludert kommunekode (hvis tilgjengelig)");
define("INV_INSTR_TAX_EXEMPTION_CODE", "Hvis en avgift kan bortfalle på produktet grunnet en kundes MVA-nummer, eller kunden er en forhandler, oppgi referansen her.");
...
define("INV_REDIRECTED_TO_INVOICE_SUMMARY", "Du er blitt omdirigert til  oversikten for fakturaer.");
...
define("INV_MNU_BACKUP_RESTORE_DESC", "Sikkerhetskopiér eller gjenopprett dine data");
...
//Account Expiry
define("INV_SUB_EXPIRY_MESSAGE", "Vennligst vær oppmerksom på at din brukerkonto har blitt satt til %s. Grunnen til dette er: %s<br /><br />Vennligst kontakt oss om du har noen spørsmål om dette.");
...
define("INV_SUB_EXPIRY_REASON_CANCELLED", "din ordre på brukerabonnement er blitt annullert.");
define("INV_SUB_EXPIRY_REASON_DELETED", "din ordre på brukerabonnement er blitt slettet.");
...
define("INV_CONTINUE_HOME", "Klikk her for å returnere til hovedsiden.");
...
define("INV_DATABASE_OOD", "ADVARSEL! Din database må oppdateres. Om dette ikke gjøres, vil det føre til programfeil. %s for å oppdatere nå.");
...
define("INV_PATCH_COPY_FAILURES", "Et forsøk ble gjort på å installere en oppdateringspakke, men følgende filer kunne ikke kopieres. Vennligst last ned pakken fra " . INV_BRANDING_NAME . " sin nettside, og installer manuelt.");
define("INV_PATCH_DB_ERRORS", "Et forsøk ble gjort på å installere en oppdateringspakke, men følgende databasefeil oppstod. Du må kanskje laste ned pakken fra " . INV_BRANDING_NAME . " sin nettside og installere manuelt.");
define("INV_PATCH_FAILED_TO_INSTALL", "Et forsøk ble gjort på å installere en oppdateringspakke, men en eller flere feil oppstod. Dette er kanskje på grunn av at dine fil- og mapperettigheter ikke tillater PHP å overskrive filene, eventuelt kan det være problemer med forbindelsen til serveren hvor oppdateringspakken ligger. Vennligst forsøk igjen senere, eller last ned pakken fra " . INV_BRANDING_NAME . " sin nettside, og installer manuelt.");
...
// Version 1.2.0
define("INV_MNU_STYLESHEET_WARNING", "ADVARSEL! Din ADMIN-mal laster ikke nBill sitt stilsett. Alt vil se galt ut med mindre du legge til en kode til din admin-mal. Se %s.");
define("INV_MNU_STYLESHEET_WARNING_1011", "ADVARSEL! Du bruker en utdatert og USIKKER versjon av Joomla! En følge av dette, er at ADMIN-malen ikke laster nBill sitt stilsett. Alt vil se galt ut med mindre du enten oppgradere Joomla (anbefales), eller legger til en kode i admin-malen din. Se %s.");
define("INV_LICENSE_EXPIRES_SOON", "ADVARSEL! Din lisens utløper snart (%s).");
define("INV_LIC_EXP_ANNUAL", " Hvis du ønsker å fornyes for ett år nå uten å miste noe av gjenværende tid på denne lisensen, vennligst logg deg inn på " . INV_BRANDING_WEBSITE . " og forny din *eksisterende* bestilling (heller enn å bestille en ny).");
...
//Version 1.2.1
define("INV_CANNOT_UPGRADE_120", "Beklager, du kan ikke oppgradere fra en versjon før 1.2.0. Du må avinstallere denne versjonen og installere versjon 1.2.0 for å oppgradere databasen, og deretter prøve å oppgradere til denne versjonen.");
define("INV_TEMP_NOT_WRITABLE", "Midlertidig PHP-mappe ble ikke funnet eller er ikke skrivbar ('%s') - fakturavedlegg kunne ikke lagres.");
...
define("INV_EMAIL_INVALID", "E-postadressen du oppga er ikke gyldig.");
