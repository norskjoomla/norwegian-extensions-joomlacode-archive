...
DEFINE('_CMN_JAVASCRIPT','Advarsel. Java script må aktiveres for rett visning av sidene.');
...
DEFINE('_EMPTY_BLOG','Uten innhold');
...
DEFINE('_SEARCH_ANYWORDS','Vilkårlig ord');
...
DEFINE('_MAIL_SUB','Bruker sendte');
...
DEFINE('_FEED_NAME','Strømmens navn');
DEFINE('_FEED_ARTICLES','Antall artikler');
DEFINE('_FEED_LINK','Strømmens lenke');
