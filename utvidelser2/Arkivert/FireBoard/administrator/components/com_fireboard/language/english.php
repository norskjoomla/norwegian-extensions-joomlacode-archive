...
DEFINE('_FB_CFNW', 'FATAL ERROR: Config File Not writeable');
DEFINE('_FB_CFS', 'Configuration file saved');
DEFINE('_FB_CFCNBO', 'FATAL ERROR: File could not be opened.');
...
DEFINE('_POST_FAVORITED_TOPIC', 'Your favorite has been processed.');
DEFINE('_VIEW_UNFAVORITETXT', 'Unfavorite');
DEFINE('_VIEW_UNSUBSCRIBETXT', 'Unsubscribe');
DEFINE('_USER_NOFAVORITES', 'No Favorites');
DEFINE('_POST_SUCCESS_FAVORITE', 'Your favorite has been processed.');
...
DEFINE('_USER_FAVORITES', 'Your Favorites');
