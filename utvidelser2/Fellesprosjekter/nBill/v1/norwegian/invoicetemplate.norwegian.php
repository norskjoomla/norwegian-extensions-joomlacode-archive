...
define("INV_PRT_CLIENT_TAX_REF", "Kundens MVA.nr.:");
define("INV_PRT_DESC", "Beskrivelse");
define("INV_PRT_UNIT_PRICE", "Stykkpris");
...
define("INV_PAYMENT_RECEIVED", "Vi takker for mottatt betaling");
...
define("INV_REMITTANCE_INTRO", "Vennligst legg ved denne betalingsinformasjonen om du sender betaling i posten, slik at vi kan se hva betalingen din gjelder. På forhånd takk!");
...
define("INV_IF_NO_SCHEDULE", "Om du ønsker å betale denne på en annen måte kan du");
define("INV_PAY_THIS_INVOICE", "klikke her for å betale på nett");
?>