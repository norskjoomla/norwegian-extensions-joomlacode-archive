...
define("INV_REMINDERS_WARNING", "Denne funksjonen har potensial til å sende e-post til ALLE dine kunder. Vær forsiktig med masseutsendelse!");
...
define("INV_INSTR_REMINDER_ACTIVE", "Skal sendes e-post for denne påminnelsen?");
...
define("INV_INSTR_REMINDER_STARTING_FROM", "Når skal e-post med påminnelser starte? Hvis feltet er tomt vil påminnelse bli sendt uavhengig av dato).");
define("INV_REMINDER_NO_OF_UNITS", "Antall enheter");
define("INV_INSTR_REMINDER_NO_OF_UNITS", "Angi antall enheter for intervallet mellom hendelsen og påminnelsen (eller i tilfelle av brukerdefinerte påminnelser, intervallet mellom påminnelser). Eks: Intervall på 7 dager. Sett tallet til 7 og enheten til 'Dager'.");
...
define("INV_INSTR_REMINDER_SEND_AFTER", "Skal det sendes påminnelse etter hendelsen? Vanligvis bare brukt på forfalte fakturaer - dvs. å sende en påminnelse x dager etter forfallsdato på faktura).");
...
define("INV_REMINDERS_SENT_NO_LICENSE", INV_BRANDING_NAME . " Lisenskoden er feil eller ble ikke funnet");
define("INV_REMINDERS_SENT_TO", "sendt til");
define("INV_REMINDERS_SENT_FOR","for kunde");
define("INV_REMINDERS_SENT_MESSAGE", "MELDING:");
define("INV_REMINDER_SENT_ERROR", "ADVARSEL! Det oppstod en feil ved forsøk på å sende denne påminnelsen. Påminnelse er ikke sendt.");
define("INV_REMINDER_SENT_ERROR_NO_CLIENT", "ADVARSEL! Det oppstod en feil ved forsøk på å sende denne påminnelsen. Ingen kunde poster ble funnet. Påminnelse er ikke sendt.");
