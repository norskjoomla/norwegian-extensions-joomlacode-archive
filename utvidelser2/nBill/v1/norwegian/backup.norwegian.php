...
//Backup/Restore
define("INV_BACKUP_RESTORE_TITLE", "Sikkerhetskopiér eller gjenopprett");
...
define("INV_BACKUP_WHAT", "Klikk på en av linkene for å laste ned sikkerhetskopien. (Avhengig av størrelsen kan det ta litt tid):");
...
define("INV_INSTR_RESTORE_WHAT", "Om du skal gjenopprette fra en sikkerhetskopi som inneholder ALLE tabeller, kan du velge å bare gjenopprette " . INV_BRANDING_NAME . " tabeller (og beholde resten uberørt), eller å gjenopprette alle tabeller til innholdet i sikkerhetskopien. Om sikkerhetskopien din bare inneholder " . INV_BRANDING_NAME . " tabeller, blir bare " . INV_BRANDING_NAME . " tabeller gjenopprettet.");
...
define("INV_ERR_NO_DATA_FOUND_IN_FILE", "En feil har oppstått under forsøk på gjenoppretting - ingen data ble funnet i filen! Ingen endringer er gjort.");
define("INV_ERR_FILE_NOT_VALID", "Filen du valgte er ikke en gyldig " . INV_BRANDING_NAME . " sikkerhetskopi. Ingen endringer er gjort.");
...
define("INV_ERR_FILE_NOT_FOUND", "Ingen sikkerhetskopi ble funnet. Ingen endringer er gjort.");
...
define("INV_NO_NON_BILLING_PRESENT", "ADVARSEL! Du valgte å gjenopprette ALLE tabeller, men filen du valgte inneholdt " . strtoupper(INV_BRANDING_NAME) . " tabellene. Faktureringstabellene ble gjenopprettet, de andre ble ikke rørt.");
define("INV_RETURN_TO_BACKUP", "Tilbake til side for sikkerhetskopiering og gjenoppretting");
?>
