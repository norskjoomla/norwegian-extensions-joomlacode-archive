...
//Version 2.0.1
define("NBILL_GATEWAY_NO_RECURRING", "Beklager, denne betalingskanalen støtter ikke periodiske betalinger");
define("NBILL_GATEWAY_DOES_NOT_SUPPORT_FREQUENCY", "Beklager, denne betalingskanalen støtter ikke den valgte betalingsfrekvensen");
define("NBILL_GATEWAY_NO_FREE_TRIALS", "Beklager, denne betalingskanalen støtter ikke prøveversjoner");
define("NBILL_GATEWAY_NO_FIRST_PAYMENT_DIFFERENT", "Beklager, denne betalingskanalen støtter ikke å ha et annet beløp for den første betalingen enn for de periodiske betalingene");
define("NBILL_GATEWAY_NO_FIXED_INSTALLMENTS", "Beklager, denne betalingskanalen støtter ikke et fast antall betalinger");
define("NBILL_GATEWAY_MIN_PAYMENTS", "Beklager, gir denne betalingskanalen tillater bare et minimum av %s betalinger");
define("NBILL_GATEWAY_ERR_SUFFIX", " - det vil ikke være mulig å betale for denne bestillingen på nettet.");