...
$JLMS_LANGUAGE['_JLMS_PLANS_MSG_SUBS_N_BASIC'] = 'If the subscription is not basic then you must set regular payment period length and check that the payments are recurring.';
...
$JLMS_LANGUAGE['_JLMS_PLANS_PERIOD_LENGTH'] = 'Period length';
