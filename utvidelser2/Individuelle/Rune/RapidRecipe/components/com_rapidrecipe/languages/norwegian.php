...
define('_RR_CONF_AUTHOR_APPEAR',    'Opphavsnavn vises i informasjonsblokk (om nei vil den vises under oppskriftens tittel): ');
define('_RR_CONF_NAVIGATION', 'Navigasjonmeny på visningside for oppskrift: ');
define('_RR_CONF_BACKBUTTON', 'Tilbake-knapp: ');
define('_CMN_USE_GLOBAL', 'Bruk global');
define('_RR_CONF_CAT_IMAGE_WIDTH', 'Kategorilistebilde - bredde: ');
define('_RR_CONF_CAT_LOGO', 'På kategorisider, vil du at sideikon alltid skal vises (kategoribilde vil bli vist om "Nei" er valgt): ');
define('_RR_CONF_PAGES', 'Kategorisides toppbilde - bredde: ');
define('_RR_CONF_NR_REC', 'Antall oppskrifter per kategoriside');
define('_RR_CONF_NAV_POSITION', 'Navigasjonmeny på kategoriside:  ');
define('_RR_CONF_LOGO_IMAGE', 'Logobilde (velg et bilde fra mappen ');
define('_RR_CONF_VOTES', 'Stemmer');
define('_RR_CONF_VOTE_NR', 'Maks antall stemmer:  ');
define('_RR_CONF_VOTE_IMAGE', 'Stemmebilde: ');
define('_RR_CONF_FEATURED', 'Utvalgt');
define('_RR_CONF_FEATURE_HOME', 'Utvalgt oppskriftmodul på førstesiden: ');
define('_RR_CONF_FEATURE_WAY', 'Utvalgt oppskrift - Utvelgelsemåte: ');
define('_RR_CONF_FEATURE_TYPE_RANDOM', 'Tilfeldig for hver lasting av side ');
define('_RR_CONF_FEATURE_TYPE_DAY', 'Tilfeldig, endres en gang per dag     ');
define('_RR_CONF_FEATURE_TYPE_WEEK', 'Tilfeldig, endres en gang per uke     ');
define('_RR_CONF_FEATURE_TYPE_MANUAL', 'Manuelt (angis av administrator)     ');
define('_RR_CONF_HIDE_FROM_UNREGISTERED', 'Skjul fremgangsmåte for uregistrerte brukere');
define('_RR_USER_GROUP', 'Gruppe som har rett til å se oppskrift');
