...
$langvars = array (
	...
	'PHPSHOP_MODULE_LIST_NAME' => 'Modulnavn',
	'PHPSHOP_MODULE_LIST_PERMS' => 'Modulrettigheter',
	'PHPSHOP_MODULE_LIST_FUNCTIONS' => 'Funksjoner',
	'PHPSHOP_MODULE_FORM_LBL' => 'Modulinformasjon',
	'PHPSHOP_MODULE_FORM_MODULE_LABEL' => 'Modultittel (til toppmeny)',
	'PHPSHOP_MODULE_FORM_NAME' => 'Modulnavn',
	'PHPSHOP_MODULE_FORM_PERMS' => 'Modulrettigheter',
	'PHPSHOP_MODULE_FORM_HEADER' => 'Moduloverskrift',
	'PHPSHOP_MODULE_FORM_FOOTER' => 'Modulbunn',
	'PHPSHOP_MODULE_FORM_MENU' => 'Vis modul i adminmeny?',
	'PHPSHOP_MODULE_FORM_ORDER' => 'Visningsrekkefølge',
	'PHPSHOP_MODULE_FORM_DESCRIPTION' => 'Modulbeskrivelse',
	...
	'PHPSHOP_FUNCTION_FORM_LBL' => 'Funksjonsinfo',
	...
	'PHPSHOP_CURRENCY_LIST_NAME' => 'Valutanavn',
	'PHPSHOP_CURRENCY_LIST_CODE' => 'Valutakode',
	'PHPSHOP_COUNTRY_LIST_LBL' => 'Landsliste',
	'PHPSHOP_COUNTRY_LIST_NAME' => 'Land',
	'PHPSHOP_COUNTRY_LIST_3_CODE' => 'Landkode (3)',
	'PHPSHOP_COUNTRY_LIST_2_CODE' => 'Landkode (2)',
	'PHPSHOP_STATE_LIST_MNU' => 'Vis fylker',
	'PHPSHOP_STATE_LIST_LBL' => 'Fylkesliste: ',
	'PHPSHOP_STATE_LIST_ADD' => 'Legg til/oppdater fylke',
	'PHPSHOP_STATE_LIST_NAME' => 'Navn på fylke',
	'PHPSHOP_STATE_LIST_3_CODE' => 'Fylkeskode (3)',
	'PHPSHOP_STATE_LIST_2_CODE' => 'Fylkeskode (2)',
	...
	'PHPSHOP_ADMIN_CFG_VIRTUAL_TAX' => 'Virtuell MVA',
	'PHPSHOP_ADMIN_CFG_VIRTUAL_TAX_EXPLAIN' => 'Dette bestemmer om varer med NULL vekt skal være med i MVA-beregningen eller ikke. Endre ps_checkout.php->calc_order_taxable() for dine innstillinger.',
	...
	'PHPSHOP_ADMIN_CFG_HOMEPAGE_EXPLAIN' => 'Dette er siden som blir åpnet som standardside.',
	'PHPSHOP_ADMIN_CFG_ERRORPAGE' => 'FEILMELDINGSIDE',
	'PHPSHOP_ADMIN_CFG_ERRORPAGE_EXPLAIN' => 'Dette er standardside for visning av feilmeldinger.',
	'PHPSHOP_ADMIN_CFG_DEBUG' => 'DEBUG ?',
	'PHPSHOP_ADMIN_CFG_DEBUG_EXPLAIN' => 'FEILSØK?  	   	Slår på feilgenerering. Dette gjør at DEBUGPAGE vises nederst på hver side. Nyttig når butikken opprettes fordi den viser detaljer om handlekurv, skjemaverdier osv.',
	'PHPSHOP_ADMIN_CFG_FLYPAGE' => 'FLYPAGE',
	'PHPSHOP_ADMIN_CFG_FLYPAGE_EXPLAIN' => 'Dette er standarside for visning av produktdetaljer.',
	'PHPSHOP_ADMIN_CFG_CATEGORY_TEMPLATE' => 'Kategori',
	'PHPSHOP_ADMIN_CFG_CATEGORY_TEMPLATE_EXPLAIN' => 'Dette bestemmer standardmal for visning av produkter i en produktkategori.<br />
	...
	'PHPSHOP_ADMIN_CFG_SHOWPHPSHOP_VERSION' => 'Vis bunntekst/logo',
	'PHPSHOP_ADMIN_CFG_SHOWPHPSHOP_VERSION_EXPLAIN' => 'Viser "powered-by-Virtuemart"-bilde.',
	'PHPSHOP_ADMIN_CFG_STORE_SHIPPING_METHOD_STANDARD' => 'Standard leveringsmodul med forskjellige transportører og kostnader. <strong>ANBEFALES!</strong>',
	...
	'PHPSHOP_ADMIN_CFG_STORE_SHIPPING_METHOD_DISABLE' => 'Skru av leveringsmodul. Velges om du selger nedlastbare produkter som ikke skal sendes.',
	'PHPSHOP_ADMIN_CFG_ENABLE_CHECKOUTBAR' => 'Vis symboler når kunden er i kassen',
	'PHPSHOP_ADMIN_CFG_ENABLE_CHECKOUTBAR_EXPLAIN' => 'Velges dersom du ønsker å vise symboler for hvor i prosessen kunden er ( 1 - 2 - 3 - 4 med bilder).',
	'PHPSHOP_ADMIN_CFG_CHECKOUT_PROCESS' => 'Velg utsjekkingsprosessen for din butikk.',
	...
	'PHPSHOP_ADMIN_CFG_ORDER_ENABLE_DOWNLOADS_EXPLAIN' => 'Velger ordrestatusen som lar kunden laste ned valgt(e) produkt(er).',
	...
	'PHPSHOP_COUPONS' => 'Rabattkoder',
	'PHPSHOP_COUPONS_ENABLE' => 'Aktiver bruk av rabattkoder',
	'PHPSHOP_COUPONS_ENABLE_EXPLAIN' => 'Om du aktiverer bruk av rabattkoder kan kunder med rabattkode bruke dette i kassen.',
	'PHPSHOP_ADMIN_CFG_PDF_BUTTON' => 'PDF-knapp',
	'PHPSHOP_ADMIN_CFG_PDF_BUTTON_EXPLAIN' => 'Vis/skjul PDF-knapp i butikken',
	'PHPSHOP_ADMIN_CFG_AGREE_TERMS_ONORDER' => 'Må akseptere Salgs- og leveringsbetingelser på alle ordre?',
	'PHPSHOP_ADMIN_CFG_AGREE_TERMS_ONORDER_EXPLAIN' => 'Velges dersom du vil at kundene må akseptere Salgs- og leveringsbetingelser på alle ordre før "Fullfør ordre".',
	'PHPSHOP_ADMIN_CFG_SHOW_OUT_OF_STOCK_PRODUCTS' => 'Vis produkter som ikke er på lager',
	'PHPSHOP_ADMIN_CFG_SHOW_OUT_OF_STOCK_PRODUCTS_EXPLAIN' => 'Når valgt vil produkter som ikke er på lager vises. Om ikke valgt vil disse produkter være usynlige til de er på lager igjen.',
	'PHPSHOP_ADMIN_CFG_SHOP_OFFLINE' => 'Butikken er nede?',
	'PHPSHOP_ADMIN_CFG_SHOP_OFFLINE_TIP' => 'Om valgt vil det vises en melding om at butikken er nede.',
	'PHPSHOP_ADMIN_CFG_SHOP_OFFLINE_MSG' => 'Melding når butikken er nede',
	'PHPSHOP_ADMIN_CFG_TABLEPREFIX' => 'Tabellprefiks for butikkens tabeller',
	'PHPSHOP_ADMIN_CFG_TABLEPREFIX_TIP' => 'Dette er <strong>vm</strong> etter standard',
	'PHPSHOP_ADMIN_CFG_NAV_AT_TOP' => 'Vis sidenavigasjon over produktlisten?',
	...
	'PHPSHOP_ADMIN_CFG_SHIPPING_NO_SELECTION' => 'Du må velge minst en leveringsmåte.',
	...
	'PHPSHOP_ADMIN_CFG_MORE_CORE_SETTINGS' => 'Flere kjerneinnstillinger',
	'PHPSHOP_ADMIN_CFG_CORE_SETTINGS' => 'Kjerneinnstillinger',
	...
	'PHPSHOP_ADMIN_CFG_ACCOUNT_ACTIVATION' => 'Ny kontoaktivering nødvendig?',
	'VM_FIELDMANAGER_NAME' => 'Navn på felt',
	'VM_FIELDMANAGER_TITLE' => 'Tittel på felt',
	'VM_FIELDMANAGER_TYPE' => 'Felttype',
	'VM_FIELDMANAGER_REQUIRED' => 'Må fylles ut',
	'VM_FIELDMANAGER_PUBLISHED' => 'Publisert',
	'VM_FIELDMANAGER_SHOW_ON_REGISTRATION' => 'Vis ved registrering',
	'VM_FIELDMANAGER_SHOW_ON_ACCOUNT' => 'Vis ved vedlikehold av konto',
	'VM_USERFIELD_FORM_LBL' => 'Legg til / endre felter',
	'VM_BROWSE_ORDERBY_DEFAULT_FIELD_LBL' => 'Standard visningsrekkefølge for produkter',
	'VM_BROWSE_ORDERBY_DEFAULT_FIELD_LBL_TIP' => 'Defines by which field products are ordered by default on the browse pages',
	'VM_BROWSE_ORDERBY_FIELDS_LBL' => 'Sorter produkter etter',
