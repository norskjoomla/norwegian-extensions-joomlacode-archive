    ...
    <tbody>
        <tr class = "fb_sth">
            <th colspan = "2" class = "view-th <?php echo $boardclass; ?>sectiontableheader">
               <a href="<?php echo htmlspecialchars(sefRelToAbs("index.php?".$_SERVER["QUERY_STRING"]))?>#<?php echo $msg_id; ?>">#<?php echo $msg_id; ?></a>
            </th>
        </tr>
        ...
        <tr>
            ...
            <td class = "fb-msgview-right">
                <table width = "100%" border = "0" cellspacing = "0" cellpadding = "0">
                    <tr>
                        <td align = "left">
                            <span class = "msgtitle"><?php echo $msg_subject; ?> </span> <span class = "msgdate" title="<?php echo $msg_date?>"><?php echo " ". _POSTED_AT ." " .date(_DATETIME,$fmessage->time); ?></span>
                        </td>
  ...
  <tr>
            ...
            <td class = "fb-msgview-right-c" >  
                   ...
                   <?php 
                            ...
                            ?>                                
                            <a  href="<?php echo $link;?>" title="#<?php echo $msg_id;?>"><?php echo _FB_REPORT;?></a> &nbsp;
                            <?php  } ?>
                            
                            <?php echo $fbIcons['msgip'] ? '<img src="' . JB_URLICONSPATH . '' . $fbIcons['msgip'] . '" border="0" alt="'. _FB_REPORT_LOGGED.'" />' . '' : '  <img src="' . JB_URLEMOTIONSPATH . 'ip.gif" border="0"   alt="'. _FB_REPORT_LOGGED.'" />'; ?> <span class="fb_smalltext"> <?php echo _FB_REPORT_LOGGED;?></span>
