...
define("INV_EXPENDITURE_INTRO", "Her kan du registrere alle dine utgifter dirkete på riktige kontoer slik at rapporter kan lages.");
define("INV_PAYMENT_NO", "Utbetalingsnummer");
define("INV_PAYMENT_DATE", "Utbetalingsdato");
define("INV_PAID_TO", "Betalt til");
define("INV_PAYMENT_AMOUNT", "Beløp");
define("INV_PAYMENT_FOR", "For");
define("INV_EXP_LEDGER_BREAKDOWN_MISMATCH", "ADVARSEL! Totalen på kontoregistreringen samsvarer ikke med beløpet for utgifter. Klikk OK om du vil fortsette likevel, eller klikk på Avbryt og endre på registreringen eller på utgiftsbeløpet.");
...
define("INV_INSTR_SUPPLIER", "Hvis du allerede har definert leverandøren i leverandørlista kan du velge her. Hvis dette er et engangstilfelle, kan du  skrive inn leverandørdetaljer nedenfor.");
...
define("INV_INSTR_PAYMENT_REFERENCE", "Din referanse til leverandøren for denne betalingen");
...
define("INV_INSTR_EXP_TAX_REFERENCE", "MVA-nummer til denne leverandøren");
...
define("INV_EXP_WHAT_FOR", "ADVARSEL! Du har ikke angitt hva betalingen gjelder. Klikk OK for å lagre likevel, eller klikk Avbryt for å gå tilbake og skrive hva betalingen gjelder.");
define("INV_EXP_NO_AMOUNT", "ADVARSEL! Du har ikke skrevet beløp. Klikk OK for å lagre likevel, eller klikk Avbryt for å gå tilbake og skrive inn et beløp.");
...
define("INV_GENERATE_PAYMENTS_UP_TO", "Skriv inn dato (YYYY/MM/DD) og lag utbetalingsnumre fram til denne datoen. Registreringer etter denne datoen vil ikke automatisk bli gitt et utbetalingsnummer.");
...
define("INV_RELATED_CREDITS", "Relatert kreditnota eller kreditnotaer");
define("INV_INSTR_RELATED_CREDITS", "Hvis denne utgiften er for betaling med en eller flere kreditnotaer, velg kreditnota her (ubetalte kreditnota er listet her).");
